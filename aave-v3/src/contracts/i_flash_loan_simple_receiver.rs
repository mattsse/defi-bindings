pub use iflashloansimplereceiver_mod::*;
#[allow(clippy::too_many_arguments)]
mod iflashloansimplereceiver_mod {
    ...
    pub static IFLASHLOANSIMPLERECEIVER_BYTECODE: ethers::contract::Lazy<
    ...
    impl<'a, M: ethers::providers::Middleware> IFlashLoanSimpleReceiver<M> {
        ...
        > {
            let factory = ethers::contract::ContractFactory::new(
                IFLASHLOANSIMPLERECEIVER_ABI.clone(),
                IFLASHLOANSIMPLERECEIVER_BYTECODE.clone().into(),
                client,
            );
