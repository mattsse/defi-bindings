pub use incentivizederc20_mod::*;
#[allow(clippy::too_many_arguments)]
mod incentivizederc20_mod {
    ...
    pub static INCENTIVIZEDERC20_BYTECODE: ethers::contract::Lazy<ethers::core::types::Bytes> =
    ...
    impl<'a, M: ethers::providers::Middleware> IncentivizedERC20<M> {
        ...
        > {
            let factory = ethers::contract::ContractFactory::new(
                ...
                INCENTIVIZEDERC20_BYTECODE.clone().into(),
                client,
            );
