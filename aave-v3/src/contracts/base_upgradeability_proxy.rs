...
pub mod base_upgradeability_proxy {
    ...
    #[doc = "BaseUpgradeabilityProxy was auto-generated with ethers-rs Abigen. More information at: https://github.com/gakonst/ethers-rs"]
    use std::sync::Arc;
    ...
    impl<M: ethers::providers::Middleware> std::fmt::Debug for BaseUpgradeabilityProxy<M> {
        fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            f.debug_tuple(stringify!(BaseUpgradeabilityProxy))
                .field(&self.address())
                .finish()
        }
    }
