...
pub mod g_pv_2_safe_erc20 {
    ...
    impl<M: ethers::providers::Middleware> std::fmt::Debug for GPv2SafeERC20<M> {
        fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            f.debug_tuple(stringify!(GPv2SafeERC20))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ethers::providers::Middleware> GPv2SafeERC20<M> {
        ...
        pub fn new<T: Into<ethers::core::types::Address>>(
            ...
            ethers::contract::Contract::new(address.into(), GPV2SAFEERC20_ABI.clone(), client)
                .into()
        }
    ...
    impl<M: ethers::providers::Middleware> From<ethers::contract::Contract<M>> for GPv2SafeERC20<M> {
