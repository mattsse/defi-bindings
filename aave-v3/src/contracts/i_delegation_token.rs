pub use idelegationtoken_mod::*;
#[allow(clippy::too_many_arguments)]
mod idelegationtoken_mod {
    ...
    pub static IDELEGATIONTOKEN_ABI: ethers::contract::Lazy<ethers::core::abi::Abi> =
        ethers::contract::Lazy::new(|| {
            serde_json :: from_str ("[{\"inputs\":[{\"internalType\":\"address\",\"name\":\"delegatee\",\"type\":\"address\",\"components\":[]}],\"stateMutability\":\"nonpayable\",\"type\":\"function\",\"name\":\"delegate\",\"outputs\":[]}]") . expect ("invalid abi")
        });
    #[doc = r" Bytecode of the #name contract"]
    pub static IDELEGATIONTOKEN_BYTECODE: ethers::contract::Lazy<ethers::core::types::Bytes> =
    ...
    impl<'a, M: ethers::providers::Middleware> IDelegationToken<M> {
        ...
        > {
            let factory = ethers::contract::ContractFactory::new(
                ...
                IDELEGATIONTOKEN_BYTECODE.clone().into(),
                client,
            );
