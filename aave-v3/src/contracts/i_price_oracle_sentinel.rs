pub use ipriceoraclesentinel_mod::*;
#[allow(clippy::too_many_arguments)]
mod ipriceoraclesentinel_mod {
    ...
    impl<'a, M: ethers::providers::Middleware> IPriceOracleSentinel<M> {
        ...
        > {
            let factory = ethers::contract::ContractFactory::new(
                IPRICEORACLESENTINEL_ABI.clone(),
                IPRICEORACLESENTINEL_BYTECODE.clone().into(),
                client,
            );
