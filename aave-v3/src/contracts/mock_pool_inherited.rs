pub use mockpoolinherited_mod::*;
#[allow(clippy::too_many_arguments)]
mod mockpoolinherited_mod {
    ...
    impl<'a, M: ethers::providers::Middleware> MockPoolInherited<M> {
        ...
        pub fn new<T: Into<ethers::core::types::Address>>(
            ...
            ethers::contract::Contract::new(address.into(), MOCKPOOLINHERITED_ABI.clone(), client)
                .into()
        }
        ...
        #[doc = "Calls the contract's `setMaxNumberOfReserves` (0x57c68dc4) function"]
        ...
        pub fn events(&self) -> ethers::contract::builders::Event<M, MockPoolInheritedEvents> {
    ...
    impl ethers::contract::EthLogDecode for MockPoolInheritedEvents {
            ...
            Self: Sized,
        {
            ...
            if let Ok(decoded) = IsolationModeTotalDebtUpdatedFilter::decode_log(log) {
                return Ok(MockPoolInheritedEvents::IsolationModeTotalDebtUpdatedFilter(decoded));
            }
            ...
            if let Ok(decoded) = RebalanceStableBorrowRateFilter::decode_log(log) {
                return Ok(MockPoolInheritedEvents::RebalanceStableBorrowRateFilter(
                    decoded,
                ));
            }
            ...
            if let Ok(decoded) = ReserveUsedAsCollateralDisabledFilter::decode_log(log) {
                return Ok(MockPoolInheritedEvents::ReserveUsedAsCollateralDisabledFilter(decoded));
            }
            if let Ok(decoded) = ReserveUsedAsCollateralEnabledFilter::decode_log(log) {
                return Ok(MockPoolInheritedEvents::ReserveUsedAsCollateralEnabledFilter(decoded));
            }
    ...
    impl ::std::fmt::Display for MockPoolInheritedEvents {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                MockPoolInheritedEvents::BackUnbackedFilter(element) => element.fmt(f),
                MockPoolInheritedEvents::BorrowFilter(element) => element.fmt(f),
                MockPoolInheritedEvents::FlashLoanFilter(element) => element.fmt(f),
                MockPoolInheritedEvents::IsolationModeTotalDebtUpdatedFilter(element) => {
                    element.fmt(f)
                }
                MockPoolInheritedEvents::LiquidationCallFilter(element) => element.fmt(f),
                MockPoolInheritedEvents::MintUnbackedFilter(element) => element.fmt(f),
                MockPoolInheritedEvents::MintedToTreasuryFilter(element) => element.fmt(f),
                MockPoolInheritedEvents::RebalanceStableBorrowRateFilter(element) => element.fmt(f),
                MockPoolInheritedEvents::RepayFilter(element) => element.fmt(f),
                MockPoolInheritedEvents::ReserveDataUpdatedFilter(element) => element.fmt(f),
                MockPoolInheritedEvents::ReserveUsedAsCollateralDisabledFilter(element) => {
                    element.fmt(f)
                }
                MockPoolInheritedEvents::ReserveUsedAsCollateralEnabledFilter(element) => {
                    element.fmt(f)
                }
                MockPoolInheritedEvents::SupplyFilter(element) => element.fmt(f),
                MockPoolInheritedEvents::SwapBorrowRateModeFilter(element) => element.fmt(f),
                MockPoolInheritedEvents::UserEModeSetFilter(element) => element.fmt(f),
                MockPoolInheritedEvents::WithdrawFilter(element) => element.fmt(f),
            }
        }
    }
    ...
    #[doc = "Container type for all input parameters for the `setMaxNumberOfReserves`function with signature `setMaxNumberOfReserves(uint16)` and selector `[87, 198, 141, 196]`"]
    #[derive(
        Clone,
        Debug,
        Default,
    ...
    #[ethcall(
        ...
        abi = "setMaxNumberOfReserves(uint16)"
    )]
    ...
    impl ethers::core::abi::AbiDecode for MockPoolInheritedCalls {
        fn decode(data: impl AsRef<[u8]>) -> Result<Self, ethers::core::abi::AbiError> {
            ...
            {
                return Ok(MockPoolInheritedCalls::AddressesProvider(decoded));
            }
            if let Ok(decoded) =
                <BridgeProtocolFeeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MockPoolInheritedCalls::BridgeProtocolFee(decoded));
            }
            if let Ok(decoded) =
                <FlashloanPremiumTotalCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MockPoolInheritedCalls::FlashloanPremiumTotal(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MockPoolInheritedCalls::FlashloanPremiumToProtocol(decoded));
            }
            if let Ok(decoded) =
                <MaxNumberReservesCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MockPoolInheritedCalls::MaxNumberReserves(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MockPoolInheritedCalls::MaxStableRateBorrowSizePercent(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MockPoolInheritedCalls::GetReserveNormalizedIncome(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MockPoolInheritedCalls::GetReserveNormalizedVariableDebt(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MockPoolInheritedCalls::GetReservesList(decoded));
            }
            if let Ok(decoded) =
                <GetUserAccountDataCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MockPoolInheritedCalls::GetUserAccountData(decoded));
            }
            if let Ok(decoded) =
                <GetUserConfigurationCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MockPoolInheritedCalls::GetUserConfiguration(decoded));
            }
            if let Ok(decoded) =
                <GetUserEModeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MockPoolInheritedCalls::GetUserEMode(decoded));
            }
            if let Ok(decoded) =
                <InitReserveCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MockPoolInheritedCalls::InitReserve(decoded));
            }
            if let Ok(decoded) =
                <InitializeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MockPoolInheritedCalls::Initialize(decoded));
            }
            if let Ok(decoded) =
                <LiquidationCallCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MockPoolInheritedCalls::LiquidationCall(decoded));
            }
            if let Ok(decoded) =
                <MintToTreasuryCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MockPoolInheritedCalls::MintToTreasury(decoded));
            }
            if let Ok(decoded) =
                <MintUnbackedCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MockPoolInheritedCalls::MintUnbacked(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MockPoolInheritedCalls::RebalanceStableBorrowRate(decoded));
            }
            if let Ok(decoded) = <RepayCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MockPoolInheritedCalls::Repay(decoded));
            }
            if let Ok(decoded) =
                <RepayWithATokensCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MockPoolInheritedCalls::RepayWithATokens(decoded));
            }
            if let Ok(decoded) =
                <RepayWithPermitCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MockPoolInheritedCalls::RepayWithPermit(decoded));
            }
            if let Ok(decoded) =
                <RescueTokensCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MockPoolInheritedCalls::RescueTokens(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MockPoolInheritedCalls::ResetIsolationModeTotalDebt(decoded));
            }
            if let Ok(decoded) =
                <SetConfigurationCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MockPoolInheritedCalls::SetConfiguration(decoded));
            }
            if let Ok(decoded) =
                <SetMaxNumberOfReservesCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MockPoolInheritedCalls::SetMaxNumberOfReserves(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MockPoolInheritedCalls::SetReserveInterestRateStrategyAddress(decoded));
            }
            if let Ok(decoded) =
                <SetUserEModeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MockPoolInheritedCalls::SetUserEMode(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MockPoolInheritedCalls::SetUserUseReserveAsCollateral(
                    decoded,
                ));
            }
            if let Ok(decoded) = <SupplyCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MockPoolInheritedCalls::Supply(decoded));
            }
            if let Ok(decoded) =
                <SupplyWithPermitCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MockPoolInheritedCalls::SupplyWithPermit(decoded));
            }
            if let Ok(decoded) =
                <SwapBorrowRateModeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MockPoolInheritedCalls::SwapBorrowRateMode(decoded));
            }
            if let Ok(decoded) =
                <UpdateBridgeProtocolFeeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MockPoolInheritedCalls::UpdateBridgeProtocolFee(decoded));
            }
            if let Ok(decoded) =
                <UpdateFlashloanPremiumsCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MockPoolInheritedCalls::UpdateFlashloanPremiums(decoded));
            }
            if let Ok(decoded) =
                <WithdrawCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MockPoolInheritedCalls::Withdraw(decoded));
            }
    ...
    impl ethers::core::abi::AbiEncode for MockPoolInheritedCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                MockPoolInheritedCalls::AddressesProvider(element) => element.encode(),
                MockPoolInheritedCalls::BridgeProtocolFee(element) => element.encode(),
                MockPoolInheritedCalls::FlashloanPremiumTotal(element) => element.encode(),
                MockPoolInheritedCalls::FlashloanPremiumToProtocol(element) => element.encode(),
                MockPoolInheritedCalls::MaxNumberReserves(element) => element.encode(),
                MockPoolInheritedCalls::MaxStableRateBorrowSizePercent(element) => element.encode(),
                MockPoolInheritedCalls::PoolRevision(element) => element.encode(),
                MockPoolInheritedCalls::BackUnbacked(element) => element.encode(),
                MockPoolInheritedCalls::Borrow(element) => element.encode(),
                MockPoolInheritedCalls::ConfigureEModeCategory(element) => element.encode(),
                MockPoolInheritedCalls::Deposit(element) => element.encode(),
                MockPoolInheritedCalls::DropReserve(element) => element.encode(),
                MockPoolInheritedCalls::FinalizeTransfer(element) => element.encode(),
                MockPoolInheritedCalls::FlashLoan(element) => element.encode(),
                MockPoolInheritedCalls::FlashLoanSimple(element) => element.encode(),
                MockPoolInheritedCalls::GetConfiguration(element) => element.encode(),
                MockPoolInheritedCalls::GetEModeCategoryData(element) => element.encode(),
                MockPoolInheritedCalls::GetReserveAddressById(element) => element.encode(),
                MockPoolInheritedCalls::GetReserveData(element) => element.encode(),
                MockPoolInheritedCalls::GetReserveNormalizedIncome(element) => element.encode(),
                MockPoolInheritedCalls::GetReserveNormalizedVariableDebt(element) => {
                    element.encode()
                }
                MockPoolInheritedCalls::GetReservesList(element) => element.encode(),
                MockPoolInheritedCalls::GetUserAccountData(element) => element.encode(),
                MockPoolInheritedCalls::GetUserConfiguration(element) => element.encode(),
                MockPoolInheritedCalls::GetUserEMode(element) => element.encode(),
                MockPoolInheritedCalls::InitReserve(element) => element.encode(),
                MockPoolInheritedCalls::Initialize(element) => element.encode(),
                MockPoolInheritedCalls::LiquidationCall(element) => element.encode(),
                MockPoolInheritedCalls::MintToTreasury(element) => element.encode(),
                MockPoolInheritedCalls::MintUnbacked(element) => element.encode(),
                MockPoolInheritedCalls::RebalanceStableBorrowRate(element) => element.encode(),
                MockPoolInheritedCalls::Repay(element) => element.encode(),
                MockPoolInheritedCalls::RepayWithATokens(element) => element.encode(),
                MockPoolInheritedCalls::RepayWithPermit(element) => element.encode(),
                MockPoolInheritedCalls::RescueTokens(element) => element.encode(),
                MockPoolInheritedCalls::ResetIsolationModeTotalDebt(element) => element.encode(),
                MockPoolInheritedCalls::SetConfiguration(element) => element.encode(),
                MockPoolInheritedCalls::SetMaxNumberOfReserves(element) => element.encode(),
                MockPoolInheritedCalls::SetReserveInterestRateStrategyAddress(element) => {
                    element.encode()
                }
                MockPoolInheritedCalls::SetUserEMode(element) => element.encode(),
                MockPoolInheritedCalls::SetUserUseReserveAsCollateral(element) => element.encode(),
                MockPoolInheritedCalls::Supply(element) => element.encode(),
                MockPoolInheritedCalls::SupplyWithPermit(element) => element.encode(),
                MockPoolInheritedCalls::SwapBorrowRateMode(element) => element.encode(),
                MockPoolInheritedCalls::UpdateBridgeProtocolFee(element) => element.encode(),
                MockPoolInheritedCalls::UpdateFlashloanPremiums(element) => element.encode(),
                MockPoolInheritedCalls::Withdraw(element) => element.encode(),
            }
        }
    }
    impl ::std::fmt::Display for MockPoolInheritedCalls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                MockPoolInheritedCalls::AddressesProvider(element) => element.fmt(f),
                MockPoolInheritedCalls::BridgeProtocolFee(element) => element.fmt(f),
                MockPoolInheritedCalls::FlashloanPremiumTotal(element) => element.fmt(f),
                MockPoolInheritedCalls::FlashloanPremiumToProtocol(element) => element.fmt(f),
                MockPoolInheritedCalls::MaxNumberReserves(element) => element.fmt(f),
                MockPoolInheritedCalls::MaxStableRateBorrowSizePercent(element) => element.fmt(f),
                MockPoolInheritedCalls::PoolRevision(element) => element.fmt(f),
                MockPoolInheritedCalls::BackUnbacked(element) => element.fmt(f),
                MockPoolInheritedCalls::Borrow(element) => element.fmt(f),
                MockPoolInheritedCalls::ConfigureEModeCategory(element) => element.fmt(f),
                MockPoolInheritedCalls::Deposit(element) => element.fmt(f),
                MockPoolInheritedCalls::DropReserve(element) => element.fmt(f),
                MockPoolInheritedCalls::FinalizeTransfer(element) => element.fmt(f),
                MockPoolInheritedCalls::FlashLoan(element) => element.fmt(f),
                MockPoolInheritedCalls::FlashLoanSimple(element) => element.fmt(f),
                MockPoolInheritedCalls::GetConfiguration(element) => element.fmt(f),
                MockPoolInheritedCalls::GetEModeCategoryData(element) => element.fmt(f),
                MockPoolInheritedCalls::GetReserveAddressById(element) => element.fmt(f),
                MockPoolInheritedCalls::GetReserveData(element) => element.fmt(f),
                MockPoolInheritedCalls::GetReserveNormalizedIncome(element) => element.fmt(f),
                MockPoolInheritedCalls::GetReserveNormalizedVariableDebt(element) => element.fmt(f),
                MockPoolInheritedCalls::GetReservesList(element) => element.fmt(f),
                MockPoolInheritedCalls::GetUserAccountData(element) => element.fmt(f),
                MockPoolInheritedCalls::GetUserConfiguration(element) => element.fmt(f),
                MockPoolInheritedCalls::GetUserEMode(element) => element.fmt(f),
                MockPoolInheritedCalls::InitReserve(element) => element.fmt(f),
                MockPoolInheritedCalls::Initialize(element) => element.fmt(f),
                MockPoolInheritedCalls::LiquidationCall(element) => element.fmt(f),
                MockPoolInheritedCalls::MintToTreasury(element) => element.fmt(f),
                MockPoolInheritedCalls::MintUnbacked(element) => element.fmt(f),
                MockPoolInheritedCalls::RebalanceStableBorrowRate(element) => element.fmt(f),
                MockPoolInheritedCalls::Repay(element) => element.fmt(f),
                MockPoolInheritedCalls::RepayWithATokens(element) => element.fmt(f),
                MockPoolInheritedCalls::RepayWithPermit(element) => element.fmt(f),
                MockPoolInheritedCalls::RescueTokens(element) => element.fmt(f),
                MockPoolInheritedCalls::ResetIsolationModeTotalDebt(element) => element.fmt(f),
                MockPoolInheritedCalls::SetConfiguration(element) => element.fmt(f),
                MockPoolInheritedCalls::SetMaxNumberOfReserves(element) => element.fmt(f),
                MockPoolInheritedCalls::SetReserveInterestRateStrategyAddress(element) => {
                    element.fmt(f)
                }
                MockPoolInheritedCalls::SetUserEMode(element) => element.fmt(f),
                MockPoolInheritedCalls::SetUserUseReserveAsCollateral(element) => element.fmt(f),
                MockPoolInheritedCalls::Supply(element) => element.fmt(f),
                MockPoolInheritedCalls::SupplyWithPermit(element) => element.fmt(f),
                MockPoolInheritedCalls::SwapBorrowRateMode(element) => element.fmt(f),
                MockPoolInheritedCalls::UpdateBridgeProtocolFee(element) => element.fmt(f),
                MockPoolInheritedCalls::UpdateFlashloanPremiums(element) => element.fmt(f),
                MockPoolInheritedCalls::Withdraw(element) => element.fmt(f),
            }
        }
    }
    impl ::std::convert::From<AddressesProviderCall> for MockPoolInheritedCalls {
        fn from(var: AddressesProviderCall) -> Self {
            MockPoolInheritedCalls::AddressesProvider(var)
        }
    }
    impl ::std::convert::From<BridgeProtocolFeeCall> for MockPoolInheritedCalls {
        fn from(var: BridgeProtocolFeeCall) -> Self {
            MockPoolInheritedCalls::BridgeProtocolFee(var)
        }
    }
    impl ::std::convert::From<FlashloanPremiumTotalCall> for MockPoolInheritedCalls {
        fn from(var: FlashloanPremiumTotalCall) -> Self {
            MockPoolInheritedCalls::FlashloanPremiumTotal(var)
        }
    }
    impl ::std::convert::From<FlashloanPremiumToProtocolCall> for MockPoolInheritedCalls {
        fn from(var: FlashloanPremiumToProtocolCall) -> Self {
            MockPoolInheritedCalls::FlashloanPremiumToProtocol(var)
        }
    }
    impl ::std::convert::From<MaxNumberReservesCall> for MockPoolInheritedCalls {
        fn from(var: MaxNumberReservesCall) -> Self {
            MockPoolInheritedCalls::MaxNumberReserves(var)
        }
    }
    impl ::std::convert::From<MaxStableRateBorrowSizePercentCall> for MockPoolInheritedCalls {
        fn from(var: MaxStableRateBorrowSizePercentCall) -> Self {
            MockPoolInheritedCalls::MaxStableRateBorrowSizePercent(var)
        }
    }
    impl ::std::convert::From<PoolRevisionCall> for MockPoolInheritedCalls {
        fn from(var: PoolRevisionCall) -> Self {
            MockPoolInheritedCalls::PoolRevision(var)
        }
    }
    impl ::std::convert::From<BackUnbackedCall> for MockPoolInheritedCalls {
        fn from(var: BackUnbackedCall) -> Self {
            MockPoolInheritedCalls::BackUnbacked(var)
        }
    }
    impl ::std::convert::From<BorrowCall> for MockPoolInheritedCalls {
        fn from(var: BorrowCall) -> Self {
            MockPoolInheritedCalls::Borrow(var)
        }
    }
    impl ::std::convert::From<ConfigureEModeCategoryCall> for MockPoolInheritedCalls {
        fn from(var: ConfigureEModeCategoryCall) -> Self {
            MockPoolInheritedCalls::ConfigureEModeCategory(var)
        }
    }
    impl ::std::convert::From<DepositCall> for MockPoolInheritedCalls {
        fn from(var: DepositCall) -> Self {
            MockPoolInheritedCalls::Deposit(var)
        }
    }
    impl ::std::convert::From<DropReserveCall> for MockPoolInheritedCalls {
        fn from(var: DropReserveCall) -> Self {
            MockPoolInheritedCalls::DropReserve(var)
        }
    }
    impl ::std::convert::From<FinalizeTransferCall> for MockPoolInheritedCalls {
        fn from(var: FinalizeTransferCall) -> Self {
            MockPoolInheritedCalls::FinalizeTransfer(var)
        }
    }
    impl ::std::convert::From<FlashLoanCall> for MockPoolInheritedCalls {
        fn from(var: FlashLoanCall) -> Self {
            MockPoolInheritedCalls::FlashLoan(var)
        }
    }
    impl ::std::convert::From<FlashLoanSimpleCall> for MockPoolInheritedCalls {
        fn from(var: FlashLoanSimpleCall) -> Self {
            MockPoolInheritedCalls::FlashLoanSimple(var)
        }
    }
    impl ::std::convert::From<GetConfigurationCall> for MockPoolInheritedCalls {
        fn from(var: GetConfigurationCall) -> Self {
            MockPoolInheritedCalls::GetConfiguration(var)
        }
    }
    impl ::std::convert::From<GetEModeCategoryDataCall> for MockPoolInheritedCalls {
        fn from(var: GetEModeCategoryDataCall) -> Self {
            MockPoolInheritedCalls::GetEModeCategoryData(var)
        }
    }
    impl ::std::convert::From<GetReserveAddressByIdCall> for MockPoolInheritedCalls {
        fn from(var: GetReserveAddressByIdCall) -> Self {
            MockPoolInheritedCalls::GetReserveAddressById(var)
        }
    }
    impl ::std::convert::From<GetReserveDataCall> for MockPoolInheritedCalls {
        fn from(var: GetReserveDataCall) -> Self {
            MockPoolInheritedCalls::GetReserveData(var)
        }
    }
    impl ::std::convert::From<GetReserveNormalizedIncomeCall> for MockPoolInheritedCalls {
        fn from(var: GetReserveNormalizedIncomeCall) -> Self {
            MockPoolInheritedCalls::GetReserveNormalizedIncome(var)
        }
    }
    impl ::std::convert::From<GetReserveNormalizedVariableDebtCall> for MockPoolInheritedCalls {
        fn from(var: GetReserveNormalizedVariableDebtCall) -> Self {
            MockPoolInheritedCalls::GetReserveNormalizedVariableDebt(var)
        }
    }
    impl ::std::convert::From<GetReservesListCall> for MockPoolInheritedCalls {
        fn from(var: GetReservesListCall) -> Self {
            MockPoolInheritedCalls::GetReservesList(var)
        }
    }
    impl ::std::convert::From<GetUserAccountDataCall> for MockPoolInheritedCalls {
        fn from(var: GetUserAccountDataCall) -> Self {
            MockPoolInheritedCalls::GetUserAccountData(var)
        }
    }
    impl ::std::convert::From<GetUserConfigurationCall> for MockPoolInheritedCalls {
        fn from(var: GetUserConfigurationCall) -> Self {
            MockPoolInheritedCalls::GetUserConfiguration(var)
        }
    }
    impl ::std::convert::From<GetUserEModeCall> for MockPoolInheritedCalls {
        fn from(var: GetUserEModeCall) -> Self {
            MockPoolInheritedCalls::GetUserEMode(var)
        }
    }
    impl ::std::convert::From<InitReserveCall> for MockPoolInheritedCalls {
        fn from(var: InitReserveCall) -> Self {
            MockPoolInheritedCalls::InitReserve(var)
        }
    }
    impl ::std::convert::From<InitializeCall> for MockPoolInheritedCalls {
        fn from(var: InitializeCall) -> Self {
            MockPoolInheritedCalls::Initialize(var)
        }
    }
    impl ::std::convert::From<LiquidationCallCall> for MockPoolInheritedCalls {
        fn from(var: LiquidationCallCall) -> Self {
            MockPoolInheritedCalls::LiquidationCall(var)
        }
    }
    impl ::std::convert::From<MintToTreasuryCall> for MockPoolInheritedCalls {
        fn from(var: MintToTreasuryCall) -> Self {
            MockPoolInheritedCalls::MintToTreasury(var)
        }
    }
    impl ::std::convert::From<MintUnbackedCall> for MockPoolInheritedCalls {
        fn from(var: MintUnbackedCall) -> Self {
            MockPoolInheritedCalls::MintUnbacked(var)
        }
    }
    impl ::std::convert::From<RebalanceStableBorrowRateCall> for MockPoolInheritedCalls {
        fn from(var: RebalanceStableBorrowRateCall) -> Self {
            MockPoolInheritedCalls::RebalanceStableBorrowRate(var)
        }
    }
    impl ::std::convert::From<RepayCall> for MockPoolInheritedCalls {
        fn from(var: RepayCall) -> Self {
            MockPoolInheritedCalls::Repay(var)
        }
    }
    impl ::std::convert::From<RepayWithATokensCall> for MockPoolInheritedCalls {
        fn from(var: RepayWithATokensCall) -> Self {
            MockPoolInheritedCalls::RepayWithATokens(var)
        }
    }
    impl ::std::convert::From<RepayWithPermitCall> for MockPoolInheritedCalls {
        fn from(var: RepayWithPermitCall) -> Self {
            MockPoolInheritedCalls::RepayWithPermit(var)
        }
    }
    impl ::std::convert::From<RescueTokensCall> for MockPoolInheritedCalls {
        fn from(var: RescueTokensCall) -> Self {
            MockPoolInheritedCalls::RescueTokens(var)
        }
    }
    impl ::std::convert::From<ResetIsolationModeTotalDebtCall> for MockPoolInheritedCalls {
        fn from(var: ResetIsolationModeTotalDebtCall) -> Self {
            MockPoolInheritedCalls::ResetIsolationModeTotalDebt(var)
        }
    }
    impl ::std::convert::From<SetConfigurationCall> for MockPoolInheritedCalls {
        fn from(var: SetConfigurationCall) -> Self {
            MockPoolInheritedCalls::SetConfiguration(var)
        }
    }
    impl ::std::convert::From<SetMaxNumberOfReservesCall> for MockPoolInheritedCalls {
        fn from(var: SetMaxNumberOfReservesCall) -> Self {
            MockPoolInheritedCalls::SetMaxNumberOfReserves(var)
        }
    }
    impl ::std::convert::From<SetReserveInterestRateStrategyAddressCall> for MockPoolInheritedCalls {
        fn from(var: SetReserveInterestRateStrategyAddressCall) -> Self {
            MockPoolInheritedCalls::SetReserveInterestRateStrategyAddress(var)
        }
    }
    impl ::std::convert::From<SetUserEModeCall> for MockPoolInheritedCalls {
        fn from(var: SetUserEModeCall) -> Self {
            MockPoolInheritedCalls::SetUserEMode(var)
        }
    }
    impl ::std::convert::From<SetUserUseReserveAsCollateralCall> for MockPoolInheritedCalls {
        fn from(var: SetUserUseReserveAsCollateralCall) -> Self {
            MockPoolInheritedCalls::SetUserUseReserveAsCollateral(var)
        }
    }
    impl ::std::convert::From<SupplyCall> for MockPoolInheritedCalls {
        fn from(var: SupplyCall) -> Self {
            MockPoolInheritedCalls::Supply(var)
        }
    }
    impl ::std::convert::From<SupplyWithPermitCall> for MockPoolInheritedCalls {
        fn from(var: SupplyWithPermitCall) -> Self {
            MockPoolInheritedCalls::SupplyWithPermit(var)
        }
    }
    impl ::std::convert::From<SwapBorrowRateModeCall> for MockPoolInheritedCalls {
        fn from(var: SwapBorrowRateModeCall) -> Self {
            MockPoolInheritedCalls::SwapBorrowRateMode(var)
        }
    }
    impl ::std::convert::From<UpdateBridgeProtocolFeeCall> for MockPoolInheritedCalls {
        fn from(var: UpdateBridgeProtocolFeeCall) -> Self {
            MockPoolInheritedCalls::UpdateBridgeProtocolFee(var)
        }
    }
    impl ::std::convert::From<UpdateFlashloanPremiumsCall> for MockPoolInheritedCalls {
        fn from(var: UpdateFlashloanPremiumsCall) -> Self {
            MockPoolInheritedCalls::UpdateFlashloanPremiums(var)
        }
    }
    impl ::std::convert::From<WithdrawCall> for MockPoolInheritedCalls {
        fn from(var: WithdrawCall) -> Self {
            MockPoolInheritedCalls::Withdraw(var)
        }
    }
}
