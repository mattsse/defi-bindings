...
pub mod mock_reserve_interest_rate_strategy {
    ...
    > = ethers::contract::Lazy::new(|| {
        "" . parse () . expect ("invalid bytecode")
    });
    pub struct MockReserveInterestRateStrategy<M>(ethers::contract::Contract<M>);
    impl<M> Clone for MockReserveInterestRateStrategy<M> {
        fn clone(&self) -> Self {
            MockReserveInterestRateStrategy(self.0.clone())
        }
    }
    ...
    impl ethers::core::abi::AbiDecode for MockReserveInterestRateStrategyCalls {
        fn decode(
            ...
            {
                return Ok(MockReserveInterestRateStrategyCalls::GetBaseVariableBorrowRate(decoded));
            }
            if let Ok(decoded) =
