...
mod pool_mod {
    ...
    impl<M: ethers::providers::Middleware> std::fmt::Debug for Pool<M> {
    ...
    impl<'a, M: ethers::providers::Middleware> Pool<M> {
    ...
    impl ::std::fmt::Display for PoolEvents {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                PoolEvents::BackUnbackedFilter(element) => element.fmt(f),
                PoolEvents::BorrowFilter(element) => element.fmt(f),
                PoolEvents::FlashLoanFilter(element) => element.fmt(f),
                PoolEvents::IsolationModeTotalDebtUpdatedFilter(element) => element.fmt(f),
                PoolEvents::LiquidationCallFilter(element) => element.fmt(f),
                PoolEvents::MintUnbackedFilter(element) => element.fmt(f),
                PoolEvents::MintedToTreasuryFilter(element) => element.fmt(f),
                PoolEvents::RebalanceStableBorrowRateFilter(element) => element.fmt(f),
                PoolEvents::RepayFilter(element) => element.fmt(f),
                PoolEvents::ReserveDataUpdatedFilter(element) => element.fmt(f),
                PoolEvents::ReserveUsedAsCollateralDisabledFilter(element) => element.fmt(f),
                PoolEvents::ReserveUsedAsCollateralEnabledFilter(element) => element.fmt(f),
                PoolEvents::SupplyFilter(element) => element.fmt(f),
                PoolEvents::SwapBorrowRateModeFilter(element) => element.fmt(f),
                PoolEvents::UserEModeSetFilter(element) => element.fmt(f),
    ...
    impl ethers::core::abi::AbiDecode for PoolCalls {
        fn decode(data: impl AsRef<[u8]>) -> Result<Self, ethers::core::abi::AbiError> {
            ...
            {
                return Ok(PoolCalls::FlashloanPremiumToProtocol(decoded));
            }
            if let Ok(decoded) =
                <MaxNumberReservesCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(PoolCalls::MaxNumberReserves(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(PoolCalls::GetReserveNormalizedIncome(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(PoolCalls::ResetIsolationModeTotalDebt(decoded));
            }
            if let Ok(decoded) =
                <SetConfigurationCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(PoolCalls::SetConfiguration(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(PoolCalls::SetReserveInterestRateStrategyAddress(decoded));
            }
            if let Ok(decoded) =
                <SetUserEModeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(PoolCalls::SetUserEMode(decoded));
            }
            if let Ok(decoded) =
    ...
    impl ethers::core::abi::AbiEncode for PoolCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                PoolCalls::AddressesProvider(element) => element.encode(),
                PoolCalls::BridgeProtocolFee(element) => element.encode(),
                PoolCalls::FlashloanPremiumTotal(element) => element.encode(),
                PoolCalls::FlashloanPremiumToProtocol(element) => element.encode(),
                PoolCalls::MaxNumberReserves(element) => element.encode(),
                PoolCalls::MaxStableRateBorrowSizePercent(element) => element.encode(),
                PoolCalls::PoolRevision(element) => element.encode(),
                PoolCalls::BackUnbacked(element) => element.encode(),
                PoolCalls::Borrow(element) => element.encode(),
                PoolCalls::ConfigureEModeCategory(element) => element.encode(),
                PoolCalls::Deposit(element) => element.encode(),
                PoolCalls::DropReserve(element) => element.encode(),
                PoolCalls::FinalizeTransfer(element) => element.encode(),
                PoolCalls::FlashLoan(element) => element.encode(),
                PoolCalls::FlashLoanSimple(element) => element.encode(),
                PoolCalls::GetConfiguration(element) => element.encode(),
                PoolCalls::GetEModeCategoryData(element) => element.encode(),
                PoolCalls::GetReserveAddressById(element) => element.encode(),
                PoolCalls::GetReserveData(element) => element.encode(),
                PoolCalls::GetReserveNormalizedIncome(element) => element.encode(),
                PoolCalls::GetReserveNormalizedVariableDebt(element) => element.encode(),
                PoolCalls::GetReservesList(element) => element.encode(),
                PoolCalls::GetUserAccountData(element) => element.encode(),
                PoolCalls::GetUserConfiguration(element) => element.encode(),
                PoolCalls::GetUserEMode(element) => element.encode(),
                PoolCalls::InitReserve(element) => element.encode(),
                PoolCalls::Initialize(element) => element.encode(),
                PoolCalls::LiquidationCall(element) => element.encode(),
                PoolCalls::MintToTreasury(element) => element.encode(),
                PoolCalls::MintUnbacked(element) => element.encode(),
                PoolCalls::RebalanceStableBorrowRate(element) => element.encode(),
                PoolCalls::Repay(element) => element.encode(),
                PoolCalls::RepayWithATokens(element) => element.encode(),
                PoolCalls::RepayWithPermit(element) => element.encode(),
                PoolCalls::RescueTokens(element) => element.encode(),
                PoolCalls::ResetIsolationModeTotalDebt(element) => element.encode(),
                PoolCalls::SetConfiguration(element) => element.encode(),
                PoolCalls::SetReserveInterestRateStrategyAddress(element) => element.encode(),
                PoolCalls::SetUserEMode(element) => element.encode(),
                PoolCalls::SetUserUseReserveAsCollateral(element) => element.encode(),
                PoolCalls::Supply(element) => element.encode(),
                PoolCalls::SupplyWithPermit(element) => element.encode(),
                PoolCalls::SwapBorrowRateMode(element) => element.encode(),
                PoolCalls::UpdateBridgeProtocolFee(element) => element.encode(),
                PoolCalls::UpdateFlashloanPremiums(element) => element.encode(),
    ...
    impl ::std::fmt::Display for PoolCalls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                PoolCalls::AddressesProvider(element) => element.fmt(f),
                PoolCalls::BridgeProtocolFee(element) => element.fmt(f),
                PoolCalls::FlashloanPremiumTotal(element) => element.fmt(f),
                PoolCalls::FlashloanPremiumToProtocol(element) => element.fmt(f),
                PoolCalls::MaxNumberReserves(element) => element.fmt(f),
                PoolCalls::MaxStableRateBorrowSizePercent(element) => element.fmt(f),
                PoolCalls::PoolRevision(element) => element.fmt(f),
                PoolCalls::BackUnbacked(element) => element.fmt(f),
                PoolCalls::Borrow(element) => element.fmt(f),
                PoolCalls::ConfigureEModeCategory(element) => element.fmt(f),
                PoolCalls::Deposit(element) => element.fmt(f),
                PoolCalls::DropReserve(element) => element.fmt(f),
                PoolCalls::FinalizeTransfer(element) => element.fmt(f),
                PoolCalls::FlashLoan(element) => element.fmt(f),
                PoolCalls::FlashLoanSimple(element) => element.fmt(f),
                PoolCalls::GetConfiguration(element) => element.fmt(f),
                PoolCalls::GetEModeCategoryData(element) => element.fmt(f),
                PoolCalls::GetReserveAddressById(element) => element.fmt(f),
                PoolCalls::GetReserveData(element) => element.fmt(f),
                PoolCalls::GetReserveNormalizedIncome(element) => element.fmt(f),
                PoolCalls::GetReserveNormalizedVariableDebt(element) => element.fmt(f),
                PoolCalls::GetReservesList(element) => element.fmt(f),
                PoolCalls::GetUserAccountData(element) => element.fmt(f),
                PoolCalls::GetUserConfiguration(element) => element.fmt(f),
                PoolCalls::GetUserEMode(element) => element.fmt(f),
                PoolCalls::InitReserve(element) => element.fmt(f),
                PoolCalls::Initialize(element) => element.fmt(f),
                PoolCalls::LiquidationCall(element) => element.fmt(f),
                PoolCalls::MintToTreasury(element) => element.fmt(f),
                PoolCalls::MintUnbacked(element) => element.fmt(f),
                PoolCalls::RebalanceStableBorrowRate(element) => element.fmt(f),
                PoolCalls::Repay(element) => element.fmt(f),
                PoolCalls::RepayWithATokens(element) => element.fmt(f),
                PoolCalls::RepayWithPermit(element) => element.fmt(f),
                PoolCalls::RescueTokens(element) => element.fmt(f),
                PoolCalls::ResetIsolationModeTotalDebt(element) => element.fmt(f),
                PoolCalls::SetConfiguration(element) => element.fmt(f),
                PoolCalls::SetReserveInterestRateStrategyAddress(element) => element.fmt(f),
                PoolCalls::SetUserEMode(element) => element.fmt(f),
                PoolCalls::SetUserUseReserveAsCollateral(element) => element.fmt(f),
                PoolCalls::Supply(element) => element.fmt(f),
                PoolCalls::SupplyWithPermit(element) => element.fmt(f),
                PoolCalls::SwapBorrowRateMode(element) => element.fmt(f),
                PoolCalls::UpdateBridgeProtocolFee(element) => element.fmt(f),
                PoolCalls::UpdateFlashloanPremiums(element) => element.fmt(f),
                PoolCalls::Withdraw(element) => element.fmt(f),
            }
        }
    }
    impl ::std::convert::From<AddressesProviderCall> for PoolCalls {
        fn from(var: AddressesProviderCall) -> Self {
            PoolCalls::AddressesProvider(var)
        }
    }
    impl ::std::convert::From<BridgeProtocolFeeCall> for PoolCalls {
        fn from(var: BridgeProtocolFeeCall) -> Self {
            PoolCalls::BridgeProtocolFee(var)
        }
    }
    impl ::std::convert::From<FlashloanPremiumTotalCall> for PoolCalls {
        fn from(var: FlashloanPremiumTotalCall) -> Self {
            PoolCalls::FlashloanPremiumTotal(var)
        }
    }
    impl ::std::convert::From<FlashloanPremiumToProtocolCall> for PoolCalls {
        fn from(var: FlashloanPremiumToProtocolCall) -> Self {
            PoolCalls::FlashloanPremiumToProtocol(var)
        }
    }
    impl ::std::convert::From<MaxNumberReservesCall> for PoolCalls {
        fn from(var: MaxNumberReservesCall) -> Self {
            PoolCalls::MaxNumberReserves(var)
        }
    }
    impl ::std::convert::From<MaxStableRateBorrowSizePercentCall> for PoolCalls {
        fn from(var: MaxStableRateBorrowSizePercentCall) -> Self {
            PoolCalls::MaxStableRateBorrowSizePercent(var)
        }
    }
    impl ::std::convert::From<PoolRevisionCall> for PoolCalls {
        fn from(var: PoolRevisionCall) -> Self {
            PoolCalls::PoolRevision(var)
        }
    }
    impl ::std::convert::From<BackUnbackedCall> for PoolCalls {
        fn from(var: BackUnbackedCall) -> Self {
            PoolCalls::BackUnbacked(var)
        }
    }
    impl ::std::convert::From<BorrowCall> for PoolCalls {
        fn from(var: BorrowCall) -> Self {
            PoolCalls::Borrow(var)
        }
    }
    impl ::std::convert::From<ConfigureEModeCategoryCall> for PoolCalls {
        fn from(var: ConfigureEModeCategoryCall) -> Self {
            PoolCalls::ConfigureEModeCategory(var)
        }
    }
    impl ::std::convert::From<DepositCall> for PoolCalls {
        fn from(var: DepositCall) -> Self {
            PoolCalls::Deposit(var)
        }
    }
    impl ::std::convert::From<DropReserveCall> for PoolCalls {
        fn from(var: DropReserveCall) -> Self {
            PoolCalls::DropReserve(var)
        }
    }
    impl ::std::convert::From<FinalizeTransferCall> for PoolCalls {
        fn from(var: FinalizeTransferCall) -> Self {
            PoolCalls::FinalizeTransfer(var)
        }
    }
    impl ::std::convert::From<FlashLoanCall> for PoolCalls {
        fn from(var: FlashLoanCall) -> Self {
            PoolCalls::FlashLoan(var)
        }
    }
    impl ::std::convert::From<FlashLoanSimpleCall> for PoolCalls {
        fn from(var: FlashLoanSimpleCall) -> Self {
            PoolCalls::FlashLoanSimple(var)
        }
    }
    impl ::std::convert::From<GetConfigurationCall> for PoolCalls {
        fn from(var: GetConfigurationCall) -> Self {
            PoolCalls::GetConfiguration(var)
        }
    }
    impl ::std::convert::From<GetEModeCategoryDataCall> for PoolCalls {
        fn from(var: GetEModeCategoryDataCall) -> Self {
            PoolCalls::GetEModeCategoryData(var)
        }
    }
    impl ::std::convert::From<GetReserveAddressByIdCall> for PoolCalls {
        fn from(var: GetReserveAddressByIdCall) -> Self {
            PoolCalls::GetReserveAddressById(var)
        }
    }
    impl ::std::convert::From<GetReserveDataCall> for PoolCalls {
        fn from(var: GetReserveDataCall) -> Self {
            PoolCalls::GetReserveData(var)
        }
    }
    impl ::std::convert::From<GetReserveNormalizedIncomeCall> for PoolCalls {
        fn from(var: GetReserveNormalizedIncomeCall) -> Self {
            PoolCalls::GetReserveNormalizedIncome(var)
        }
    }
    impl ::std::convert::From<GetReserveNormalizedVariableDebtCall> for PoolCalls {
        fn from(var: GetReserveNormalizedVariableDebtCall) -> Self {
            PoolCalls::GetReserveNormalizedVariableDebt(var)
        }
    }
    impl ::std::convert::From<GetReservesListCall> for PoolCalls {
        fn from(var: GetReservesListCall) -> Self {
            PoolCalls::GetReservesList(var)
        }
    }
    impl ::std::convert::From<GetUserAccountDataCall> for PoolCalls {
        fn from(var: GetUserAccountDataCall) -> Self {
            PoolCalls::GetUserAccountData(var)
        }
    }
    impl ::std::convert::From<GetUserConfigurationCall> for PoolCalls {
        fn from(var: GetUserConfigurationCall) -> Self {
            PoolCalls::GetUserConfiguration(var)
        }
    }
    impl ::std::convert::From<GetUserEModeCall> for PoolCalls {
        fn from(var: GetUserEModeCall) -> Self {
            PoolCalls::GetUserEMode(var)
        }
    }
    impl ::std::convert::From<InitReserveCall> for PoolCalls {
        fn from(var: InitReserveCall) -> Self {
            PoolCalls::InitReserve(var)
        }
    }
    impl ::std::convert::From<InitializeCall> for PoolCalls {
        fn from(var: InitializeCall) -> Self {
            PoolCalls::Initialize(var)
        }
    }
    impl ::std::convert::From<LiquidationCallCall> for PoolCalls {
        fn from(var: LiquidationCallCall) -> Self {
            PoolCalls::LiquidationCall(var)
        }
    }
    impl ::std::convert::From<MintToTreasuryCall> for PoolCalls {
        fn from(var: MintToTreasuryCall) -> Self {
            PoolCalls::MintToTreasury(var)
        }
    }
    impl ::std::convert::From<MintUnbackedCall> for PoolCalls {
        fn from(var: MintUnbackedCall) -> Self {
            PoolCalls::MintUnbacked(var)
        }
    }
    impl ::std::convert::From<RebalanceStableBorrowRateCall> for PoolCalls {
        fn from(var: RebalanceStableBorrowRateCall) -> Self {
            PoolCalls::RebalanceStableBorrowRate(var)
        }
    }
    impl ::std::convert::From<RepayCall> for PoolCalls {
        fn from(var: RepayCall) -> Self {
            PoolCalls::Repay(var)
        }
    }
    impl ::std::convert::From<RepayWithATokensCall> for PoolCalls {
        fn from(var: RepayWithATokensCall) -> Self {
            PoolCalls::RepayWithATokens(var)
        }
    }
    impl ::std::convert::From<RepayWithPermitCall> for PoolCalls {
        fn from(var: RepayWithPermitCall) -> Self {
            PoolCalls::RepayWithPermit(var)
        }
    }
    impl ::std::convert::From<RescueTokensCall> for PoolCalls {
        fn from(var: RescueTokensCall) -> Self {
            PoolCalls::RescueTokens(var)
        }
    }
    impl ::std::convert::From<ResetIsolationModeTotalDebtCall> for PoolCalls {
        fn from(var: ResetIsolationModeTotalDebtCall) -> Self {
            PoolCalls::ResetIsolationModeTotalDebt(var)
        }
    }
    impl ::std::convert::From<SetConfigurationCall> for PoolCalls {
        fn from(var: SetConfigurationCall) -> Self {
            PoolCalls::SetConfiguration(var)
        }
    }
    impl ::std::convert::From<SetReserveInterestRateStrategyAddressCall> for PoolCalls {
        fn from(var: SetReserveInterestRateStrategyAddressCall) -> Self {
            PoolCalls::SetReserveInterestRateStrategyAddress(var)
        }
    }
    impl ::std::convert::From<SetUserEModeCall> for PoolCalls {
        fn from(var: SetUserEModeCall) -> Self {
            PoolCalls::SetUserEMode(var)
        }
    }
    impl ::std::convert::From<SetUserUseReserveAsCollateralCall> for PoolCalls {
        fn from(var: SetUserUseReserveAsCollateralCall) -> Self {
            PoolCalls::SetUserUseReserveAsCollateral(var)
        }
    }
    impl ::std::convert::From<SupplyCall> for PoolCalls {
        fn from(var: SupplyCall) -> Self {
            PoolCalls::Supply(var)
        }
    }
    impl ::std::convert::From<SupplyWithPermitCall> for PoolCalls {
        fn from(var: SupplyWithPermitCall) -> Self {
            PoolCalls::SupplyWithPermit(var)
        }
    }
    impl ::std::convert::From<SwapBorrowRateModeCall> for PoolCalls {
        fn from(var: SwapBorrowRateModeCall) -> Self {
            PoolCalls::SwapBorrowRateMode(var)
        }
    }
    impl ::std::convert::From<UpdateBridgeProtocolFeeCall> for PoolCalls {
        fn from(var: UpdateBridgeProtocolFeeCall) -> Self {
            PoolCalls::UpdateBridgeProtocolFee(var)
        }
    }
    impl ::std::convert::From<UpdateFlashloanPremiumsCall> for PoolCalls {
        fn from(var: UpdateFlashloanPremiumsCall) -> Self {
            PoolCalls::UpdateFlashloanPremiums(var)
        }
    }
