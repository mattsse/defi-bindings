pub use versionedinitializable_mod::*;
#[allow(clippy::too_many_arguments)]
mod versionedinitializable_mod {
    ...
    pub static VERSIONEDINITIALIZABLE_BYTECODE: ethers::contract::Lazy<ethers::core::types::Bytes> =
    ...
    impl<'a, M: ethers::providers::Middleware> VersionedInitializable<M> {
        ...
        > {
            let factory = ethers::contract::ContractFactory::new(
                VERSIONEDINITIALIZABLE_ABI.clone(),
                VERSIONEDINITIALIZABLE_BYTECODE.clone().into(),
                client,
            );
