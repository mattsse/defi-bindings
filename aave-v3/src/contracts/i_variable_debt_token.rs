pub use ivariabledebttoken_mod::*;
#[allow(clippy::too_many_arguments)]
mod ivariabledebttoken_mod {
    ...
    pub static IVARIABLEDEBTTOKEN_BYTECODE: ethers::contract::Lazy<ethers::core::types::Bytes> =
    ...
    impl<'a, M: ethers::providers::Middleware> IVariableDebtToken<M> {
        ...
        > {
            let factory = ethers::contract::ContractFactory::new(
                ...
                IVARIABLEDEBTTOKEN_BYTECODE.clone().into(),
                client,
            );
