...
mod l2pool_mod {
    ...
    impl<'a, M: ethers::providers::Middleware> L2Pool<M> {
        ...
        pub fn new<T: Into<ethers::core::types::Address>>(
            ...
            ethers::contract::Contract::new(address.into(), L2POOL_ABI.clone(), client).into()
        }
        ...
        pub fn events(&self) -> ethers::contract::builders::Event<M, L2PoolEvents> {
            self.0.event_with_filter(Default::default())
        }
    }
    impl<M: ethers::providers::Middleware> From<ethers::contract::Contract<M>> for L2Pool<M> {
    ...
    impl ::std::fmt::Display for L2PoolEvents {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                L2PoolEvents::BackUnbackedFilter(element) => element.fmt(f),
                L2PoolEvents::BorrowFilter(element) => element.fmt(f),
                L2PoolEvents::FlashLoanFilter(element) => element.fmt(f),
                L2PoolEvents::IsolationModeTotalDebtUpdatedFilter(element) => element.fmt(f),
                L2PoolEvents::LiquidationCallFilter(element) => element.fmt(f),
                L2PoolEvents::MintUnbackedFilter(element) => element.fmt(f),
                L2PoolEvents::MintedToTreasuryFilter(element) => element.fmt(f),
                L2PoolEvents::RebalanceStableBorrowRateFilter(element) => element.fmt(f),
                L2PoolEvents::RepayFilter(element) => element.fmt(f),
                L2PoolEvents::ReserveDataUpdatedFilter(element) => element.fmt(f),
                L2PoolEvents::ReserveUsedAsCollateralDisabledFilter(element) => element.fmt(f),
                L2PoolEvents::ReserveUsedAsCollateralEnabledFilter(element) => element.fmt(f),
                L2PoolEvents::SupplyFilter(element) => element.fmt(f),
                L2PoolEvents::SwapBorrowRateModeFilter(element) => element.fmt(f),
                L2PoolEvents::UserEModeSetFilter(element) => element.fmt(f),
                L2PoolEvents::WithdrawFilter(element) => element.fmt(f),
            }
        }
    }
    ...
    impl ethers::core::abi::AbiDecode for L2PoolCalls {
        fn decode(data: impl AsRef<[u8]>) -> Result<Self, ethers::core::abi::AbiError> {
            ...
            {
                return Ok(L2PoolCalls::AddressesProvider(decoded));
            }
            if let Ok(decoded) =
                <BridgeProtocolFeeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(L2PoolCalls::BridgeProtocolFee(decoded));
            }
            if let Ok(decoded) =
                <FlashloanPremiumTotalCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(L2PoolCalls::FlashloanPremiumTotal(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(L2PoolCalls::FlashloanPremiumToProtocol(decoded));
            }
            if let Ok(decoded) =
                <MaxNumberReservesCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(L2PoolCalls::MaxNumberReserves(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(L2PoolCalls::MaxStableRateBorrowSizePercent(decoded));
            }
            if let Ok(decoded) =
                <PoolRevisionCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(L2PoolCalls::PoolRevision(decoded));
            }
            if let Ok(decoded) =
                <BackUnbackedCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(L2PoolCalls::BackUnbacked(decoded));
            }
            if let Ok (decoded) = < BorrowWithAssetAndAmountAndInterestRateModeAndReferralCodeAndOnBehalfOfCall as ethers :: core :: abi :: AbiDecode > :: decode (data . as_ref ()) { return Ok (L2PoolCalls :: BorrowWithAssetAndAmountAndInterestRateModeAndReferralCodeAndOnBehalfOf (decoded)) }
            if let Ok(decoded) = <BorrowCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(L2PoolCalls::Borrow(decoded));
            }
            if let Ok(decoded) =
                <ConfigureEModeCategoryCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(L2PoolCalls::ConfigureEModeCategory(decoded));
            }
            if let Ok(decoded) =
                <DepositCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(L2PoolCalls::Deposit(decoded));
            }
            if let Ok(decoded) =
                <DropReserveCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(L2PoolCalls::DropReserve(decoded));
            }
            if let Ok(decoded) =
                <FinalizeTransferCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(L2PoolCalls::FinalizeTransfer(decoded));
            }
            if let Ok(decoded) =
                <FlashLoanCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(L2PoolCalls::FlashLoan(decoded));
            }
            if let Ok(decoded) =
                <FlashLoanSimpleCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(L2PoolCalls::FlashLoanSimple(decoded));
            }
            if let Ok(decoded) =
                <GetConfigurationCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(L2PoolCalls::GetConfiguration(decoded));
            }
            if let Ok(decoded) =
                <GetEModeCategoryDataCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(L2PoolCalls::GetEModeCategoryData(decoded));
            }
            if let Ok(decoded) =
                <GetReserveAddressByIdCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(L2PoolCalls::GetReserveAddressById(decoded));
            }
            if let Ok(decoded) =
                <GetReserveDataCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(L2PoolCalls::GetReserveData(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(L2PoolCalls::GetReserveNormalizedIncome(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(L2PoolCalls::GetReserveNormalizedVariableDebt(decoded));
            }
            if let Ok(decoded) =
                <GetReservesListCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(L2PoolCalls::GetReservesList(decoded));
            }
            if let Ok(decoded) =
                <GetUserAccountDataCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(L2PoolCalls::GetUserAccountData(decoded));
            }
            if let Ok(decoded) =
                <GetUserConfigurationCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(L2PoolCalls::GetUserConfiguration(decoded));
            }
            if let Ok(decoded) =
                <GetUserEModeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(L2PoolCalls::GetUserEMode(decoded));
            }
            if let Ok(decoded) =
                <InitReserveCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(L2PoolCalls::InitReserve(decoded));
            }
            if let Ok(decoded) =
                <InitializeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(L2PoolCalls::Initialize(decoded));
            }
            if let Ok (decoded) = < LiquidationCallWithCollateralAssetAndDebtAssetAndUserAndDebtToCoverAndReceiveATokenCall as ethers :: core :: abi :: AbiDecode > :: decode (data . as_ref ()) { return Ok (L2PoolCalls :: LiquidationCallWithCollateralAssetAndDebtAssetAndUserAndDebtToCoverAndReceiveAToken (decoded)) }
            if let Ok(decoded) =
                <LiquidationCallCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(L2PoolCalls::LiquidationCall(decoded));
            }
            if let Ok(decoded) =
                <MintToTreasuryCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(L2PoolCalls::MintToTreasury(decoded));
            }
            if let Ok(decoded) =
                <MintUnbackedCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(L2PoolCalls::MintUnbacked(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(L2PoolCalls::RebalanceStableBorrowRate(decoded));
            }
            if let Ok (decoded) = < RebalanceStableBorrowRateWithAssetAndUserCall as ethers :: core :: abi :: AbiDecode > :: decode (data . as_ref ()) { return Ok (L2PoolCalls :: RebalanceStableBorrowRateWithAssetAndUser (decoded)) }
            if let Ok(decoded) = <RepayCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(L2PoolCalls::Repay(decoded));
            }
            if let Ok (decoded) = < RepayWithAssetAndAmountAndInterestRateModeAndOnBehalfOfCall as ethers :: core :: abi :: AbiDecode > :: decode (data . as_ref ()) { return Ok (L2PoolCalls :: RepayWithAssetAndAmountAndInterestRateModeAndOnBehalfOf (decoded)) }
            if let Ok (decoded) = < RepayWithATokensWithAssetAndAmountAndInterestRateModeCall as ethers :: core :: abi :: AbiDecode > :: decode (data . as_ref ()) { return Ok (L2PoolCalls :: RepayWithATokensWithAssetAndAmountAndInterestRateMode (decoded)) }
            if let Ok(decoded) =
                <RepayWithATokensCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(L2PoolCalls::RepayWithATokens(decoded));
            }
            if let Ok(decoded) =
                <RepayWithPermitCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(L2PoolCalls::RepayWithPermit(decoded));
            }
            if let Ok (decoded) = < RepayWithPermitWithAssetAndAmountAndInterestRateModeAndOnBehalfOfAndDeadlineAndPermitVAndPermitRAndPermitSCall as ethers :: core :: abi :: AbiDecode > :: decode (data . as_ref ()) { return Ok (L2PoolCalls :: RepayWithPermitWithAssetAndAmountAndInterestRateModeAndOnBehalfOfAndDeadlineAndPermitVAndPermitRAndPermitS (decoded)) }
            if let Ok(decoded) =
                <RescueTokensCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(L2PoolCalls::RescueTokens(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(L2PoolCalls::ResetIsolationModeTotalDebt(decoded));
            }
            if let Ok(decoded) =
                <SetConfigurationCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(L2PoolCalls::SetConfiguration(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(L2PoolCalls::SetReserveInterestRateStrategyAddress(decoded));
            }
            if let Ok(decoded) =
                <SetUserEModeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(L2PoolCalls::SetUserEMode(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(L2PoolCalls::SetUserUseReserveAsCollateral(decoded));
            }
            if let Ok (decoded) = < SetUserUseReserveAsCollateralWithAssetAndUseAsCollateralCall as ethers :: core :: abi :: AbiDecode > :: decode (data . as_ref ()) { return Ok (L2PoolCalls :: SetUserUseReserveAsCollateralWithAssetAndUseAsCollateral (decoded)) }
            if let Ok (decoded) = < SupplyWithAssetAndAmountAndOnBehalfOfAndReferralCodeCall as ethers :: core :: abi :: AbiDecode > :: decode (data . as_ref ()) { return Ok (L2PoolCalls :: SupplyWithAssetAndAmountAndOnBehalfOfAndReferralCode (decoded)) }
            if let Ok(decoded) = <SupplyCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(L2PoolCalls::Supply(decoded));
            }
            if let Ok (decoded) = < SupplyWithPermitWithAssetAndAmountAndOnBehalfOfAndReferralCodeAndDeadlineAndPermitVAndPermitRAndPermitSCall as ethers :: core :: abi :: AbiDecode > :: decode (data . as_ref ()) { return Ok (L2PoolCalls :: SupplyWithPermitWithAssetAndAmountAndOnBehalfOfAndReferralCodeAndDeadlineAndPermitVAndPermitRAndPermitS (decoded)) }
            if let Ok(decoded) =
                <SupplyWithPermitCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(L2PoolCalls::SupplyWithPermit(decoded));
            }
            if let Ok(decoded) =
                <SwapBorrowRateModeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(L2PoolCalls::SwapBorrowRateMode(decoded));
            }
            if let Ok (decoded) = < SwapBorrowRateModeWithAssetAndInterestRateModeCall as ethers :: core :: abi :: AbiDecode > :: decode (data . as_ref ()) { return Ok (L2PoolCalls :: SwapBorrowRateModeWithAssetAndInterestRateMode (decoded)) }
            if let Ok(decoded) =
                <UpdateBridgeProtocolFeeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(L2PoolCalls::UpdateBridgeProtocolFee(decoded));
            }
            if let Ok(decoded) =
                <UpdateFlashloanPremiumsCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(L2PoolCalls::UpdateFlashloanPremiums(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(L2PoolCalls::WithdrawWithAssetAndAmountAndTo(decoded));
            }
            if let Ok(decoded) =
                <WithdrawCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(L2PoolCalls::Withdraw(decoded));
            }
    ...
    impl ethers::core::abi::AbiEncode for L2PoolCalls {
        fn encode(self) -> Vec<u8> {
            match self { L2PoolCalls :: AddressesProvider (element) => element . encode () , L2PoolCalls :: BridgeProtocolFee (element) => element . encode () , L2PoolCalls :: FlashloanPremiumTotal (element) => element . encode () , L2PoolCalls :: FlashloanPremiumToProtocol (element) => element . encode () , L2PoolCalls :: MaxNumberReserves (element) => element . encode () , L2PoolCalls :: MaxStableRateBorrowSizePercent (element) => element . encode () , L2PoolCalls :: PoolRevision (element) => element . encode () , L2PoolCalls :: BackUnbacked (element) => element . encode () , L2PoolCalls :: BorrowWithAssetAndAmountAndInterestRateModeAndReferralCodeAndOnBehalfOf (element) => element . encode () , L2PoolCalls :: Borrow (element) => element . encode () , L2PoolCalls :: ConfigureEModeCategory (element) => element . encode () , L2PoolCalls :: Deposit (element) => element . encode () , L2PoolCalls :: DropReserve (element) => element . encode () , L2PoolCalls :: FinalizeTransfer (element) => element . encode () , L2PoolCalls :: FlashLoan (element) => element . encode () , L2PoolCalls :: FlashLoanSimple (element) => element . encode () , L2PoolCalls :: GetConfiguration (element) => element . encode () , L2PoolCalls :: GetEModeCategoryData (element) => element . encode () , L2PoolCalls :: GetReserveAddressById (element) => element . encode () , L2PoolCalls :: GetReserveData (element) => element . encode () , L2PoolCalls :: GetReserveNormalizedIncome (element) => element . encode () , L2PoolCalls :: GetReserveNormalizedVariableDebt (element) => element . encode () , L2PoolCalls :: GetReservesList (element) => element . encode () , L2PoolCalls :: GetUserAccountData (element) => element . encode () , L2PoolCalls :: GetUserConfiguration (element) => element . encode () , L2PoolCalls :: GetUserEMode (element) => element . encode () , L2PoolCalls :: InitReserve (element) => element . encode () , L2PoolCalls :: Initialize (element) => element . encode () , L2PoolCalls :: LiquidationCallWithCollateralAssetAndDebtAssetAndUserAndDebtToCoverAndReceiveAToken (element) => element . encode () , L2PoolCalls :: LiquidationCall (element) => element . encode () , L2PoolCalls :: MintToTreasury (element) => element . encode () , L2PoolCalls :: MintUnbacked (element) => element . encode () , L2PoolCalls :: RebalanceStableBorrowRate (element) => element . encode () , L2PoolCalls :: RebalanceStableBorrowRateWithAssetAndUser (element) => element . encode () , L2PoolCalls :: Repay (element) => element . encode () , L2PoolCalls :: RepayWithAssetAndAmountAndInterestRateModeAndOnBehalfOf (element) => element . encode () , L2PoolCalls :: RepayWithATokensWithAssetAndAmountAndInterestRateMode (element) => element . encode () , L2PoolCalls :: RepayWithATokens (element) => element . encode () , L2PoolCalls :: RepayWithPermit (element) => element . encode () , L2PoolCalls :: RepayWithPermitWithAssetAndAmountAndInterestRateModeAndOnBehalfOfAndDeadlineAndPermitVAndPermitRAndPermitS (element) => element . encode () , L2PoolCalls :: RescueTokens (element) => element . encode () , L2PoolCalls :: ResetIsolationModeTotalDebt (element) => element . encode () , L2PoolCalls :: SetConfiguration (element) => element . encode () , L2PoolCalls :: SetReserveInterestRateStrategyAddress (element) => element . encode () , L2PoolCalls :: SetUserEMode (element) => element . encode () , L2PoolCalls :: SetUserUseReserveAsCollateral (element) => element . encode () , L2PoolCalls :: SetUserUseReserveAsCollateralWithAssetAndUseAsCollateral (element) => element . encode () , L2PoolCalls :: SupplyWithAssetAndAmountAndOnBehalfOfAndReferralCode (element) => element . encode () , L2PoolCalls :: Supply (element) => element . encode () , L2PoolCalls :: SupplyWithPermitWithAssetAndAmountAndOnBehalfOfAndReferralCodeAndDeadlineAndPermitVAndPermitRAndPermitS (element) => element . encode () , L2PoolCalls :: SupplyWithPermit (element) => element . encode () , L2PoolCalls :: SwapBorrowRateMode (element) => element . encode () , L2PoolCalls :: SwapBorrowRateModeWithAssetAndInterestRateMode (element) => element . encode () , L2PoolCalls :: UpdateBridgeProtocolFee (element) => element . encode () , L2PoolCalls :: UpdateFlashloanPremiums (element) => element . encode () , L2PoolCalls :: WithdrawWithAssetAndAmountAndTo (element) => element . encode () , L2PoolCalls :: Withdraw (element) => element . encode () }
        }
    }
    impl ::std::fmt::Display for L2PoolCalls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self { L2PoolCalls :: AddressesProvider (element) => element . fmt (f) , L2PoolCalls :: BridgeProtocolFee (element) => element . fmt (f) , L2PoolCalls :: FlashloanPremiumTotal (element) => element . fmt (f) , L2PoolCalls :: FlashloanPremiumToProtocol (element) => element . fmt (f) , L2PoolCalls :: MaxNumberReserves (element) => element . fmt (f) , L2PoolCalls :: MaxStableRateBorrowSizePercent (element) => element . fmt (f) , L2PoolCalls :: PoolRevision (element) => element . fmt (f) , L2PoolCalls :: BackUnbacked (element) => element . fmt (f) , L2PoolCalls :: BorrowWithAssetAndAmountAndInterestRateModeAndReferralCodeAndOnBehalfOf (element) => element . fmt (f) , L2PoolCalls :: Borrow (element) => element . fmt (f) , L2PoolCalls :: ConfigureEModeCategory (element) => element . fmt (f) , L2PoolCalls :: Deposit (element) => element . fmt (f) , L2PoolCalls :: DropReserve (element) => element . fmt (f) , L2PoolCalls :: FinalizeTransfer (element) => element . fmt (f) , L2PoolCalls :: FlashLoan (element) => element . fmt (f) , L2PoolCalls :: FlashLoanSimple (element) => element . fmt (f) , L2PoolCalls :: GetConfiguration (element) => element . fmt (f) , L2PoolCalls :: GetEModeCategoryData (element) => element . fmt (f) , L2PoolCalls :: GetReserveAddressById (element) => element . fmt (f) , L2PoolCalls :: GetReserveData (element) => element . fmt (f) , L2PoolCalls :: GetReserveNormalizedIncome (element) => element . fmt (f) , L2PoolCalls :: GetReserveNormalizedVariableDebt (element) => element . fmt (f) , L2PoolCalls :: GetReservesList (element) => element . fmt (f) , L2PoolCalls :: GetUserAccountData (element) => element . fmt (f) , L2PoolCalls :: GetUserConfiguration (element) => element . fmt (f) , L2PoolCalls :: GetUserEMode (element) => element . fmt (f) , L2PoolCalls :: InitReserve (element) => element . fmt (f) , L2PoolCalls :: Initialize (element) => element . fmt (f) , L2PoolCalls :: LiquidationCallWithCollateralAssetAndDebtAssetAndUserAndDebtToCoverAndReceiveAToken (element) => element . fmt (f) , L2PoolCalls :: LiquidationCall (element) => element . fmt (f) , L2PoolCalls :: MintToTreasury (element) => element . fmt (f) , L2PoolCalls :: MintUnbacked (element) => element . fmt (f) , L2PoolCalls :: RebalanceStableBorrowRate (element) => element . fmt (f) , L2PoolCalls :: RebalanceStableBorrowRateWithAssetAndUser (element) => element . fmt (f) , L2PoolCalls :: Repay (element) => element . fmt (f) , L2PoolCalls :: RepayWithAssetAndAmountAndInterestRateModeAndOnBehalfOf (element) => element . fmt (f) , L2PoolCalls :: RepayWithATokensWithAssetAndAmountAndInterestRateMode (element) => element . fmt (f) , L2PoolCalls :: RepayWithATokens (element) => element . fmt (f) , L2PoolCalls :: RepayWithPermit (element) => element . fmt (f) , L2PoolCalls :: RepayWithPermitWithAssetAndAmountAndInterestRateModeAndOnBehalfOfAndDeadlineAndPermitVAndPermitRAndPermitS (element) => element . fmt (f) , L2PoolCalls :: RescueTokens (element) => element . fmt (f) , L2PoolCalls :: ResetIsolationModeTotalDebt (element) => element . fmt (f) , L2PoolCalls :: SetConfiguration (element) => element . fmt (f) , L2PoolCalls :: SetReserveInterestRateStrategyAddress (element) => element . fmt (f) , L2PoolCalls :: SetUserEMode (element) => element . fmt (f) , L2PoolCalls :: SetUserUseReserveAsCollateral (element) => element . fmt (f) , L2PoolCalls :: SetUserUseReserveAsCollateralWithAssetAndUseAsCollateral (element) => element . fmt (f) , L2PoolCalls :: SupplyWithAssetAndAmountAndOnBehalfOfAndReferralCode (element) => element . fmt (f) , L2PoolCalls :: Supply (element) => element . fmt (f) , L2PoolCalls :: SupplyWithPermitWithAssetAndAmountAndOnBehalfOfAndReferralCodeAndDeadlineAndPermitVAndPermitRAndPermitS (element) => element . fmt (f) , L2PoolCalls :: SupplyWithPermit (element) => element . fmt (f) , L2PoolCalls :: SwapBorrowRateMode (element) => element . fmt (f) , L2PoolCalls :: SwapBorrowRateModeWithAssetAndInterestRateMode (element) => element . fmt (f) , L2PoolCalls :: UpdateBridgeProtocolFee (element) => element . fmt (f) , L2PoolCalls :: UpdateFlashloanPremiums (element) => element . fmt (f) , L2PoolCalls :: WithdrawWithAssetAndAmountAndTo (element) => element . fmt (f) , L2PoolCalls :: Withdraw (element) => element . fmt (f) }
        }
    }
    impl ::std::convert::From<AddressesProviderCall> for L2PoolCalls {
        fn from(var: AddressesProviderCall) -> Self {
            L2PoolCalls::AddressesProvider(var)
        }
    }
    impl ::std::convert::From<BridgeProtocolFeeCall> for L2PoolCalls {
        fn from(var: BridgeProtocolFeeCall) -> Self {
            L2PoolCalls::BridgeProtocolFee(var)
        }
    }
    impl ::std::convert::From<FlashloanPremiumTotalCall> for L2PoolCalls {
        fn from(var: FlashloanPremiumTotalCall) -> Self {
            L2PoolCalls::FlashloanPremiumTotal(var)
        }
    }
    impl ::std::convert::From<FlashloanPremiumToProtocolCall> for L2PoolCalls {
        fn from(var: FlashloanPremiumToProtocolCall) -> Self {
            L2PoolCalls::FlashloanPremiumToProtocol(var)
        }
    }
    impl ::std::convert::From<MaxNumberReservesCall> for L2PoolCalls {
        fn from(var: MaxNumberReservesCall) -> Self {
            L2PoolCalls::MaxNumberReserves(var)
        }
    }
    impl ::std::convert::From<MaxStableRateBorrowSizePercentCall> for L2PoolCalls {
        fn from(var: MaxStableRateBorrowSizePercentCall) -> Self {
            L2PoolCalls::MaxStableRateBorrowSizePercent(var)
        }
    }
    impl ::std::convert::From<PoolRevisionCall> for L2PoolCalls {
        fn from(var: PoolRevisionCall) -> Self {
            L2PoolCalls::PoolRevision(var)
        }
    }
    impl ::std::convert::From<BackUnbackedCall> for L2PoolCalls {
        fn from(var: BackUnbackedCall) -> Self {
            L2PoolCalls::BackUnbacked(var)
        }
    }
    impl
        ::std::convert::From<
        ...
        > for L2PoolCalls
    {
        fn from(
            ...
            L2PoolCalls::BorrowWithAssetAndAmountAndInterestRateModeAndReferralCodeAndOnBehalfOf(
                var,
            )
        }
    }
    impl ::std::convert::From<BorrowCall> for L2PoolCalls {
        fn from(var: BorrowCall) -> Self {
            L2PoolCalls::Borrow(var)
        }
    }
    impl ::std::convert::From<ConfigureEModeCategoryCall> for L2PoolCalls {
        fn from(var: ConfigureEModeCategoryCall) -> Self {
            L2PoolCalls::ConfigureEModeCategory(var)
        }
    }
    impl ::std::convert::From<DepositCall> for L2PoolCalls {
        fn from(var: DepositCall) -> Self {
            L2PoolCalls::Deposit(var)
        }
    }
    impl ::std::convert::From<DropReserveCall> for L2PoolCalls {
        fn from(var: DropReserveCall) -> Self {
            L2PoolCalls::DropReserve(var)
        }
    }
    impl ::std::convert::From<FinalizeTransferCall> for L2PoolCalls {
        fn from(var: FinalizeTransferCall) -> Self {
            L2PoolCalls::FinalizeTransfer(var)
        }
    }
    impl ::std::convert::From<FlashLoanCall> for L2PoolCalls {
        fn from(var: FlashLoanCall) -> Self {
            L2PoolCalls::FlashLoan(var)
        }
    }
    impl ::std::convert::From<FlashLoanSimpleCall> for L2PoolCalls {
        fn from(var: FlashLoanSimpleCall) -> Self {
            L2PoolCalls::FlashLoanSimple(var)
        }
    }
    impl ::std::convert::From<GetConfigurationCall> for L2PoolCalls {
        fn from(var: GetConfigurationCall) -> Self {
            L2PoolCalls::GetConfiguration(var)
        }
    }
    impl ::std::convert::From<GetEModeCategoryDataCall> for L2PoolCalls {
        fn from(var: GetEModeCategoryDataCall) -> Self {
            L2PoolCalls::GetEModeCategoryData(var)
        }
    }
    impl ::std::convert::From<GetReserveAddressByIdCall> for L2PoolCalls {
        fn from(var: GetReserveAddressByIdCall) -> Self {
            L2PoolCalls::GetReserveAddressById(var)
        }
    }
    impl ::std::convert::From<GetReserveDataCall> for L2PoolCalls {
        fn from(var: GetReserveDataCall) -> Self {
            L2PoolCalls::GetReserveData(var)
        }
    }
    impl ::std::convert::From<GetReserveNormalizedIncomeCall> for L2PoolCalls {
        fn from(var: GetReserveNormalizedIncomeCall) -> Self {
            L2PoolCalls::GetReserveNormalizedIncome(var)
        }
    }
    impl ::std::convert::From<GetReserveNormalizedVariableDebtCall> for L2PoolCalls {
        fn from(var: GetReserveNormalizedVariableDebtCall) -> Self {
            L2PoolCalls::GetReserveNormalizedVariableDebt(var)
        }
    }
    impl ::std::convert::From<GetReservesListCall> for L2PoolCalls {
        fn from(var: GetReservesListCall) -> Self {
            L2PoolCalls::GetReservesList(var)
        }
    }
    impl ::std::convert::From<GetUserAccountDataCall> for L2PoolCalls {
        fn from(var: GetUserAccountDataCall) -> Self {
            L2PoolCalls::GetUserAccountData(var)
        }
    }
    impl ::std::convert::From<GetUserConfigurationCall> for L2PoolCalls {
        fn from(var: GetUserConfigurationCall) -> Self {
            L2PoolCalls::GetUserConfiguration(var)
        }
    }
    impl ::std::convert::From<GetUserEModeCall> for L2PoolCalls {
        fn from(var: GetUserEModeCall) -> Self {
            L2PoolCalls::GetUserEMode(var)
        }
    }
    impl ::std::convert::From<InitReserveCall> for L2PoolCalls {
        fn from(var: InitReserveCall) -> Self {
            L2PoolCalls::InitReserve(var)
        }
    }
    impl ::std::convert::From<InitializeCall> for L2PoolCalls {
        fn from(var: InitializeCall) -> Self {
            L2PoolCalls::Initialize(var)
        }
    }
    impl
        ::std::convert::From<
        ...
        > for L2PoolCalls
    {
        fn from(
            ...
            L2PoolCalls :: LiquidationCallWithCollateralAssetAndDebtAssetAndUserAndDebtToCoverAndReceiveAToken (var)
        }
    }
    impl ::std::convert::From<LiquidationCallCall> for L2PoolCalls {
        fn from(var: LiquidationCallCall) -> Self {
            L2PoolCalls::LiquidationCall(var)
        }
    }
    impl ::std::convert::From<MintToTreasuryCall> for L2PoolCalls {
        fn from(var: MintToTreasuryCall) -> Self {
            L2PoolCalls::MintToTreasury(var)
        }
    }
    impl ::std::convert::From<MintUnbackedCall> for L2PoolCalls {
        fn from(var: MintUnbackedCall) -> Self {
            L2PoolCalls::MintUnbacked(var)
        }
    }
    impl ::std::convert::From<RebalanceStableBorrowRateCall> for L2PoolCalls {
        fn from(var: RebalanceStableBorrowRateCall) -> Self {
            L2PoolCalls::RebalanceStableBorrowRate(var)
        }
    }
    impl ::std::convert::From<RebalanceStableBorrowRateWithAssetAndUserCall> for L2PoolCalls {
        fn from(var: RebalanceStableBorrowRateWithAssetAndUserCall) -> Self {
            L2PoolCalls::RebalanceStableBorrowRateWithAssetAndUser(var)
        }
    }
    impl ::std::convert::From<RepayCall> for L2PoolCalls {
        fn from(var: RepayCall) -> Self {
            L2PoolCalls::Repay(var)
        }
    }
        ...
        for L2PoolCalls
    {
        fn from(var: RepayWithAssetAndAmountAndInterestRateModeAndOnBehalfOfCall) -> Self {
            L2PoolCalls::RepayWithAssetAndAmountAndInterestRateModeAndOnBehalfOf(var)
        }
    }
        ...
        for L2PoolCalls
    {
        fn from(var: RepayWithATokensWithAssetAndAmountAndInterestRateModeCall) -> Self {
            L2PoolCalls::RepayWithATokensWithAssetAndAmountAndInterestRateMode(var)
        }
    }
    impl ::std::convert::From<RepayWithATokensCall> for L2PoolCalls {
        fn from(var: RepayWithATokensCall) -> Self {
            L2PoolCalls::RepayWithATokens(var)
        }
    }
    impl ::std::convert::From<RepayWithPermitCall> for L2PoolCalls {
        fn from(var: RepayWithPermitCall) -> Self {
            L2PoolCalls::RepayWithPermit(var)
        }
    }
    impl :: std :: convert :: From < RepayWithPermitWithAssetAndAmountAndInterestRateModeAndOnBehalfOfAndDeadlineAndPermitVAndPermitRAndPermitSCall > for L2PoolCalls { fn from (var : RepayWithPermitWithAssetAndAmountAndInterestRateModeAndOnBehalfOfAndDeadlineAndPermitVAndPermitRAndPermitSCall) -> Self { L2PoolCalls :: RepayWithPermitWithAssetAndAmountAndInterestRateModeAndOnBehalfOfAndDeadlineAndPermitVAndPermitRAndPermitS (var) } }
    impl ::std::convert::From<RescueTokensCall> for L2PoolCalls {
        fn from(var: RescueTokensCall) -> Self {
            L2PoolCalls::RescueTokens(var)
        }
    }
    impl ::std::convert::From<ResetIsolationModeTotalDebtCall> for L2PoolCalls {
        fn from(var: ResetIsolationModeTotalDebtCall) -> Self {
            L2PoolCalls::ResetIsolationModeTotalDebt(var)
        }
    }
    impl ::std::convert::From<SetConfigurationCall> for L2PoolCalls {
        fn from(var: SetConfigurationCall) -> Self {
            L2PoolCalls::SetConfiguration(var)
        }
    }
    impl ::std::convert::From<SetReserveInterestRateStrategyAddressCall> for L2PoolCalls {
        fn from(var: SetReserveInterestRateStrategyAddressCall) -> Self {
            L2PoolCalls::SetReserveInterestRateStrategyAddress(var)
        }
    }
    impl ::std::convert::From<SetUserEModeCall> for L2PoolCalls {
        fn from(var: SetUserEModeCall) -> Self {
            L2PoolCalls::SetUserEMode(var)
        }
    }
    impl ::std::convert::From<SetUserUseReserveAsCollateralCall> for L2PoolCalls {
        fn from(var: SetUserUseReserveAsCollateralCall) -> Self {
            L2PoolCalls::SetUserUseReserveAsCollateral(var)
        }
    }
        ...
        for L2PoolCalls
    {
        fn from(var: SetUserUseReserveAsCollateralWithAssetAndUseAsCollateralCall) -> Self {
            L2PoolCalls::SetUserUseReserveAsCollateralWithAssetAndUseAsCollateral(var)
        }
    }
        ...
        for L2PoolCalls
    {
        fn from(var: SupplyWithAssetAndAmountAndOnBehalfOfAndReferralCodeCall) -> Self {
            L2PoolCalls::SupplyWithAssetAndAmountAndOnBehalfOfAndReferralCode(var)
        }
    }
    impl ::std::convert::From<SupplyCall> for L2PoolCalls {
        fn from(var: SupplyCall) -> Self {
            L2PoolCalls::Supply(var)
        }
    }
    impl :: std :: convert :: From < SupplyWithPermitWithAssetAndAmountAndOnBehalfOfAndReferralCodeAndDeadlineAndPermitVAndPermitRAndPermitSCall > for L2PoolCalls { fn from (var : SupplyWithPermitWithAssetAndAmountAndOnBehalfOfAndReferralCodeAndDeadlineAndPermitVAndPermitRAndPermitSCall) -> Self { L2PoolCalls :: SupplyWithPermitWithAssetAndAmountAndOnBehalfOfAndReferralCodeAndDeadlineAndPermitVAndPermitRAndPermitS (var) } }
    impl ::std::convert::From<SupplyWithPermitCall> for L2PoolCalls {
        fn from(var: SupplyWithPermitCall) -> Self {
            L2PoolCalls::SupplyWithPermit(var)
        }
    }
    impl ::std::convert::From<SwapBorrowRateModeCall> for L2PoolCalls {
        fn from(var: SwapBorrowRateModeCall) -> Self {
            L2PoolCalls::SwapBorrowRateMode(var)
        }
    }
    impl ::std::convert::From<SwapBorrowRateModeWithAssetAndInterestRateModeCall> for L2PoolCalls {
        fn from(var: SwapBorrowRateModeWithAssetAndInterestRateModeCall) -> Self {
            L2PoolCalls::SwapBorrowRateModeWithAssetAndInterestRateMode(var)
        }
    }
    impl ::std::convert::From<UpdateBridgeProtocolFeeCall> for L2PoolCalls {
        fn from(var: UpdateBridgeProtocolFeeCall) -> Self {
            L2PoolCalls::UpdateBridgeProtocolFee(var)
        }
    }
    impl ::std::convert::From<UpdateFlashloanPremiumsCall> for L2PoolCalls {
        fn from(var: UpdateFlashloanPremiumsCall) -> Self {
            L2PoolCalls::UpdateFlashloanPremiums(var)
        }
    }
    impl ::std::convert::From<WithdrawWithAssetAndAmountAndToCall> for L2PoolCalls {
        fn from(var: WithdrawWithAssetAndAmountAndToCall) -> Self {
            L2PoolCalls::WithdrawWithAssetAndAmountAndTo(var)
        }
    }
    impl ::std::convert::From<WithdrawCall> for L2PoolCalls {
        fn from(var: WithdrawCall) -> Self {
            L2PoolCalls::Withdraw(var)
        }
    }
}
