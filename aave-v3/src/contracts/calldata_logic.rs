...
pub mod calldata_logic {
    ...
    impl<M: ethers::providers::Middleware> std::fmt::Debug for CalldataLogic<M> {
        fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            f.debug_tuple(stringify!(CalldataLogic))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ethers::providers::Middleware> CalldataLogic<M> {
        ...
        pub fn new<T: Into<ethers::core::types::Address>>(
            ...
            ethers::contract::Contract::new(address.into(), CALLDATALOGIC_ABI.clone(), client)
                .into()
        }
    ...
    impl<M: ethers::providers::Middleware> From<ethers::contract::Contract<M>> for CalldataLogic<M> {
