...
pub mod careful_math {
    ...
    impl<M: ethers::providers::Middleware> std::fmt::Debug for CarefulMath<M> {
        fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            f.debug_tuple(stringify!(CarefulMath))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ethers::providers::Middleware> CarefulMath<M> {
        ...
        pub fn new<T: Into<ethers::core::types::Address>>(
            ...
            ethers::contract::Contract::new(address.into(), CAREFULMATH_ABI.clone(), client).into()
        }
        ...
        > {
            let factory = ethers::contract::ContractFactory::new(
                CAREFULMATH_ABI.clone(),
                CAREFULMATH_BYTECODE.clone().into(),
                client,
            );
    ...
    impl<M: ethers::providers::Middleware> From<ethers::contract::Contract<M>> for CarefulMath<M> {
