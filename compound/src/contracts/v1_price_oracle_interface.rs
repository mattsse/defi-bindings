pub use v1priceoracleinterface_mod::*;
#[allow(clippy::too_many_arguments)]
mod v1priceoracleinterface_mod {
    ...
    pub static V1PRICEORACLEINTERFACE_ABI: ethers::contract::Lazy<ethers::core::abi::Abi> =
        ethers::contract::Lazy::new(|| {
            serde_json :: from_str ("[{\"inputs\":[{\"internalType\":\"address\",\"name\":\"asset\",\"type\":\"address\",\"components\":[]}],\"stateMutability\":\"view\",\"type\":\"function\",\"name\":\"assetPrices\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\",\"components\":[]}]}]") . expect ("invalid abi")
        });
    #[doc = r" Bytecode of the #name contract"]
    pub static V1PRICEORACLEINTERFACE_BYTECODE: ethers::contract::Lazy<ethers::core::types::Bytes> =
    ...
    impl<'a, M: ethers::providers::Middleware> V1PriceOracleInterface<M> {
        ...
        > {
            let factory = ethers::contract::ContractFactory::new(
                V1PRICEORACLEINTERFACE_ABI.clone(),
                V1PRICEORACLEINTERFACE_BYTECODE.clone().into(),
                client,
            );
