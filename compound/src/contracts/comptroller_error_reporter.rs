pub use comptroller_error_reporter::*;
...
pub mod comptroller_error_reporter {
    ...
    > = ethers::contract::Lazy::new(|| {
        "0x6080604052348015600f57600080fd5b50603e80601d6000396000f3fe6080604052600080fdfea265627a7a72315820d495d1cfd6be77ab7ecb5b899e0d60a3cb7292d80243811b875b4bd081d4a7a364736f6c63430005110032" . parse () . expect ("invalid bytecode")
    });
    pub struct ComptrollerErrorReporter<M>(ethers::contract::Contract<M>);
    impl<M> Clone for ComptrollerErrorReporter<M> {
        fn clone(&self) -> Self {
            ComptrollerErrorReporter(self.0.clone())
        }
    }
    ...
    impl<M: ethers::providers::Middleware> ComptrollerErrorReporter<M> {
