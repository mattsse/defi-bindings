...
mod exponential_mod {
    ...
    pub static EXPONENTIAL_BYTECODE: ethers::contract::Lazy<ethers::core::types::Bytes> =
        ethers::contract::Lazy::new(|| {
            "0x6080604052348015600f57600080fd5b50603e80601d6000396000f3fe6080604052600080fdfea265627a7a7231582016933a6ba745507d26c0fa2ec12699f5190cc08058dbefa4ae1baea3106892c564736f6c63430005110032" . parse () . expect ("invalid bytecode")
        });
    #[derive(Clone)]
    ...
    impl<'a, M: ethers::providers::Middleware> Exponential<M> {
