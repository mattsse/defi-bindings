...
mod tokenerrorreporter_mod {
    ...
    #[doc = "TokenErrorReporter was auto-generated with ethers-rs Abigen. More information at: https://github.com/gakonst/ethers-rs"]
    use std::sync::Arc;
    ...
    impl<M: ethers::providers::Middleware> std::fmt::Debug for TokenErrorReporter<M> {
        fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            f.debug_tuple(stringify!(TokenErrorReporter))
                .field(&self.address())
                .finish()
        }
    }
    impl<'a, M: ethers::providers::Middleware> TokenErrorReporter<M> {
        ...
        pub fn new<T: Into<ethers::core::types::Address>>(
            ...
            ethers::contract::Contract::new(address.into(), TOKENERRORREPORTER_ABI.clone(), client)
                .into()
        }
        ...
        > {
            let factory = ethers::contract::ContractFactory::new(
                TOKENERRORREPORTER_ABI.clone(),
                TOKENERRORREPORTER_BYTECODE.clone().into(),
                client,
            );
