pub use imapleloanfactory_mod::*;
#[allow(clippy::too_many_arguments)]
mod imapleloanfactory_mod {
    ...
    impl<'a, M: ethers::providers::Middleware> IMapleLoanFactory<M> {
        ...
        pub fn new<T: Into<ethers::core::types::Address>>(
            ...
            ethers::contract::Contract::new(address.into(), IMAPLELOANFACTORY_ABI.clone(), client)
                .into()
        }
        ...
        > {
            let factory = ethers::contract::ContractFactory::new(
                IMAPLELOANFACTORY_ABI.clone(),
                IMAPLELOANFACTORY_BYTECODE.clone().into(),
                client,
            );
        ...
        pub fn is_loan(
            ...
            self.0
                .method_hash([40, 25, 203, 194], proxy)
                .expect("method not found (this should never happen)")
        }
        ...
        pub fn events(&self) -> ethers::contract::builders::Event<M, IMapleLoanFactoryEvents> {
            self.0.event_with_filter(Default::default())
        }
    }
    impl<M: ethers::providers::Middleware> From<ethers::contract::Contract<M>>
        for IMapleLoanFactory<M>
    {
    ...
    pub enum IMapleLoanFactoryEvents {
    ...
    impl ethers::contract::EthLogDecode for IMapleLoanFactoryEvents {
        fn decode_log(log: &ethers::core::abi::RawLog) -> Result<Self, ethers::core::abi::Error>
        where
            Self: Sized,
        {
            if let Ok(decoded) = DefaultVersionSetFilter::decode_log(log) {
                return Ok(IMapleLoanFactoryEvents::DefaultVersionSetFilter(decoded));
            }
            if let Ok(decoded) = ImplementationRegisteredFilter::decode_log(log) {
                return Ok(IMapleLoanFactoryEvents::ImplementationRegisteredFilter(
                    decoded,
                ));
            }
            if let Ok(decoded) = InstanceDeployedFilter::decode_log(log) {
                return Ok(IMapleLoanFactoryEvents::InstanceDeployedFilter(decoded));
            }
            if let Ok(decoded) = InstanceUpgradedFilter::decode_log(log) {
                return Ok(IMapleLoanFactoryEvents::InstanceUpgradedFilter(decoded));
            }
            if let Ok(decoded) = MapleGlobalsSetFilter::decode_log(log) {
                return Ok(IMapleLoanFactoryEvents::MapleGlobalsSetFilter(decoded));
            }
            if let Ok(decoded) = UpgradePathDisabledFilter::decode_log(log) {
                return Ok(IMapleLoanFactoryEvents::UpgradePathDisabledFilter(decoded));
            }
            if let Ok(decoded) = UpgradePathEnabledFilter::decode_log(log) {
                return Ok(IMapleLoanFactoryEvents::UpgradePathEnabledFilter(decoded));
            }
            Err(ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::std::fmt::Display for IMapleLoanFactoryEvents {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                IMapleLoanFactoryEvents::DefaultVersionSetFilter(element) => element.fmt(f),
                IMapleLoanFactoryEvents::ImplementationRegisteredFilter(element) => element.fmt(f),
                IMapleLoanFactoryEvents::InstanceDeployedFilter(element) => element.fmt(f),
                IMapleLoanFactoryEvents::InstanceUpgradedFilter(element) => element.fmt(f),
                IMapleLoanFactoryEvents::MapleGlobalsSetFilter(element) => element.fmt(f),
                IMapleLoanFactoryEvents::UpgradePathDisabledFilter(element) => element.fmt(f),
                IMapleLoanFactoryEvents::UpgradePathEnabledFilter(element) => element.fmt(f),
            }
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq, Eq, ethers :: contract :: EthAbiType)]
    pub enum IMapleLoanFactoryCalls {
    ...
    impl ethers::core::abi::AbiDecode for IMapleLoanFactoryCalls {
        fn decode(data: impl AsRef<[u8]>) -> Result<Self, ethers::core::abi::AbiError> {
            if let Ok(decoded) =
                <CreateInstanceCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IMapleLoanFactoryCalls::CreateInstance(decoded));
            }
            if let Ok(decoded) =
                <DefaultImplementationCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IMapleLoanFactoryCalls::DefaultImplementation(decoded));
            }
            if let Ok(decoded) =
                <DefaultVersionCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IMapleLoanFactoryCalls::DefaultVersion(decoded));
            }
            if let Ok(decoded) =
                <DisableUpgradePathCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IMapleLoanFactoryCalls::DisableUpgradePath(decoded));
            }
            if let Ok(decoded) =
                <EnableUpgradePathCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IMapleLoanFactoryCalls::EnableUpgradePath(decoded));
            }
            if let Ok(decoded) =
                <GetInstanceAddressCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IMapleLoanFactoryCalls::GetInstanceAddress(decoded));
            }
            if let Ok(decoded) =
                <ImplementationOfCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IMapleLoanFactoryCalls::ImplementationOf(decoded));
            }
            if let Ok(decoded) = <IsLoanCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IMapleLoanFactoryCalls::IsLoan(decoded));
            }
            if let Ok(decoded) =
                <MapleGlobalsCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IMapleLoanFactoryCalls::MapleGlobals(decoded));
            }
            if let Ok(decoded) =
                <MigratorForPathCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IMapleLoanFactoryCalls::MigratorForPath(decoded));
            }
            if let Ok(decoded) =
                <RegisterImplementationCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IMapleLoanFactoryCalls::RegisterImplementation(decoded));
            }
            if let Ok(decoded) =
                <SetDefaultVersionCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IMapleLoanFactoryCalls::SetDefaultVersion(decoded));
            }
            if let Ok(decoded) =
                <SetGlobalsCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IMapleLoanFactoryCalls::SetGlobals(decoded));
            }
            if let Ok(decoded) =
                <UpgradeEnabledForPathCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IMapleLoanFactoryCalls::UpgradeEnabledForPath(decoded));
            }
            if let Ok(decoded) =
                <UpgradeInstanceCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IMapleLoanFactoryCalls::UpgradeInstance(decoded));
            }
            if let Ok(decoded) =
                <VersionOfCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IMapleLoanFactoryCalls::VersionOf(decoded));
            }
            Err(ethers::core::abi::Error::InvalidData.into())
        }
    }
    impl ethers::core::abi::AbiEncode for IMapleLoanFactoryCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                IMapleLoanFactoryCalls::CreateInstance(element) => element.encode(),
                IMapleLoanFactoryCalls::DefaultImplementation(element) => element.encode(),
                IMapleLoanFactoryCalls::DefaultVersion(element) => element.encode(),
                IMapleLoanFactoryCalls::DisableUpgradePath(element) => element.encode(),
                IMapleLoanFactoryCalls::EnableUpgradePath(element) => element.encode(),
                IMapleLoanFactoryCalls::GetInstanceAddress(element) => element.encode(),
                IMapleLoanFactoryCalls::ImplementationOf(element) => element.encode(),
                IMapleLoanFactoryCalls::IsLoan(element) => element.encode(),
                IMapleLoanFactoryCalls::MapleGlobals(element) => element.encode(),
                IMapleLoanFactoryCalls::MigratorForPath(element) => element.encode(),
                IMapleLoanFactoryCalls::RegisterImplementation(element) => element.encode(),
                IMapleLoanFactoryCalls::SetDefaultVersion(element) => element.encode(),
                IMapleLoanFactoryCalls::SetGlobals(element) => element.encode(),
                IMapleLoanFactoryCalls::UpgradeEnabledForPath(element) => element.encode(),
                IMapleLoanFactoryCalls::UpgradeInstance(element) => element.encode(),
                IMapleLoanFactoryCalls::VersionOf(element) => element.encode(),
            }
        }
    }
    impl ::std::fmt::Display for IMapleLoanFactoryCalls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                IMapleLoanFactoryCalls::CreateInstance(element) => element.fmt(f),
                IMapleLoanFactoryCalls::DefaultImplementation(element) => element.fmt(f),
                IMapleLoanFactoryCalls::DefaultVersion(element) => element.fmt(f),
                IMapleLoanFactoryCalls::DisableUpgradePath(element) => element.fmt(f),
                IMapleLoanFactoryCalls::EnableUpgradePath(element) => element.fmt(f),
                IMapleLoanFactoryCalls::GetInstanceAddress(element) => element.fmt(f),
                IMapleLoanFactoryCalls::ImplementationOf(element) => element.fmt(f),
                IMapleLoanFactoryCalls::IsLoan(element) => element.fmt(f),
                IMapleLoanFactoryCalls::MapleGlobals(element) => element.fmt(f),
                IMapleLoanFactoryCalls::MigratorForPath(element) => element.fmt(f),
                IMapleLoanFactoryCalls::RegisterImplementation(element) => element.fmt(f),
                IMapleLoanFactoryCalls::SetDefaultVersion(element) => element.fmt(f),
                IMapleLoanFactoryCalls::SetGlobals(element) => element.fmt(f),
                IMapleLoanFactoryCalls::UpgradeEnabledForPath(element) => element.fmt(f),
                IMapleLoanFactoryCalls::UpgradeInstance(element) => element.fmt(f),
                IMapleLoanFactoryCalls::VersionOf(element) => element.fmt(f),
            }
        }
    }
    impl ::std::convert::From<CreateInstanceCall> for IMapleLoanFactoryCalls {
        fn from(var: CreateInstanceCall) -> Self {
            IMapleLoanFactoryCalls::CreateInstance(var)
        }
    }
    impl ::std::convert::From<DefaultImplementationCall> for IMapleLoanFactoryCalls {
        fn from(var: DefaultImplementationCall) -> Self {
            IMapleLoanFactoryCalls::DefaultImplementation(var)
        }
    }
    impl ::std::convert::From<DefaultVersionCall> for IMapleLoanFactoryCalls {
        fn from(var: DefaultVersionCall) -> Self {
            IMapleLoanFactoryCalls::DefaultVersion(var)
        }
    }
    impl ::std::convert::From<DisableUpgradePathCall> for IMapleLoanFactoryCalls {
        fn from(var: DisableUpgradePathCall) -> Self {
            IMapleLoanFactoryCalls::DisableUpgradePath(var)
        }
    }
    impl ::std::convert::From<EnableUpgradePathCall> for IMapleLoanFactoryCalls {
        fn from(var: EnableUpgradePathCall) -> Self {
            IMapleLoanFactoryCalls::EnableUpgradePath(var)
        }
    }
    impl ::std::convert::From<GetInstanceAddressCall> for IMapleLoanFactoryCalls {
        fn from(var: GetInstanceAddressCall) -> Self {
            IMapleLoanFactoryCalls::GetInstanceAddress(var)
        }
    }
    impl ::std::convert::From<ImplementationOfCall> for IMapleLoanFactoryCalls {
        fn from(var: ImplementationOfCall) -> Self {
            IMapleLoanFactoryCalls::ImplementationOf(var)
        }
    }
    impl ::std::convert::From<IsLoanCall> for IMapleLoanFactoryCalls {
        fn from(var: IsLoanCall) -> Self {
            IMapleLoanFactoryCalls::IsLoan(var)
        }
    }
    impl ::std::convert::From<MapleGlobalsCall> for IMapleLoanFactoryCalls {
        fn from(var: MapleGlobalsCall) -> Self {
            IMapleLoanFactoryCalls::MapleGlobals(var)
        }
    }
    impl ::std::convert::From<MigratorForPathCall> for IMapleLoanFactoryCalls {
        fn from(var: MigratorForPathCall) -> Self {
            IMapleLoanFactoryCalls::MigratorForPath(var)
        }
    }
    impl ::std::convert::From<RegisterImplementationCall> for IMapleLoanFactoryCalls {
        fn from(var: RegisterImplementationCall) -> Self {
            IMapleLoanFactoryCalls::RegisterImplementation(var)
        }
    }
    impl ::std::convert::From<SetDefaultVersionCall> for IMapleLoanFactoryCalls {
        fn from(var: SetDefaultVersionCall) -> Self {
            IMapleLoanFactoryCalls::SetDefaultVersion(var)
        }
    }
    impl ::std::convert::From<SetGlobalsCall> for IMapleLoanFactoryCalls {
        fn from(var: SetGlobalsCall) -> Self {
            IMapleLoanFactoryCalls::SetGlobals(var)
        }
    }
    impl ::std::convert::From<UpgradeEnabledForPathCall> for IMapleLoanFactoryCalls {
        fn from(var: UpgradeEnabledForPathCall) -> Self {
            IMapleLoanFactoryCalls::UpgradeEnabledForPath(var)
        }
    }
    impl ::std::convert::From<UpgradeInstanceCall> for IMapleLoanFactoryCalls {
        fn from(var: UpgradeInstanceCall) -> Self {
            IMapleLoanFactoryCalls::UpgradeInstance(var)
        }
    }
    impl ::std::convert::From<VersionOfCall> for IMapleLoanFactoryCalls {
        fn from(var: VersionOfCall) -> Self {
            IMapleLoanFactoryCalls::VersionOf(var)
        }
    }
}
