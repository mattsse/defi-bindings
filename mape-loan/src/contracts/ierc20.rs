...
mod ierc20_mod {
    ...
    impl ethers::core::abi::AbiDecode for IERC20Calls {
        fn decode(data: impl AsRef<[u8]>) -> Result<Self, ethers::core::abi::AbiError> {
            ...
            {
                return Ok(IERC20Calls::DomainSeparator(decoded));
            }
            if let Ok(decoded) =
                <PermitTypehashCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IERC20Calls::PermitTypehash(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(IERC20Calls::DecreaseAllowance(decoded));
            }
            if let Ok(decoded) =
                <IncreaseAllowanceCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IERC20Calls::IncreaseAllowance(decoded));
            }
    ...
    impl ethers::core::abi::AbiEncode for IERC20Calls {
        fn encode(self) -> Vec<u8> {
            match self {
                IERC20Calls::DomainSeparator(element) => element.encode(),
                IERC20Calls::PermitTypehash(element) => element.encode(),
                ...
                IERC20Calls::DecreaseAllowance(element) => element.encode(),
                IERC20Calls::IncreaseAllowance(element) => element.encode(),
                IERC20Calls::Name(element) => element.encode(),
                IERC20Calls::Nonces(element) => element.encode(),
                IERC20Calls::Permit(element) => element.encode(),
    ...
    impl ::std::fmt::Display for IERC20Calls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                IERC20Calls::DomainSeparator(element) => element.fmt(f),
                IERC20Calls::PermitTypehash(element) => element.fmt(f),
                ...
                IERC20Calls::DecreaseAllowance(element) => element.fmt(f),
                IERC20Calls::IncreaseAllowance(element) => element.fmt(f),
                IERC20Calls::Name(element) => element.fmt(f),
                IERC20Calls::Nonces(element) => element.fmt(f),
                IERC20Calls::Permit(element) => element.fmt(f),
    ...
    impl ::std::convert::From<DomainSeparatorCall> for IERC20Calls {
        fn from(var: DomainSeparatorCall) -> Self {
            IERC20Calls::DomainSeparator(var)
        }
    }
    impl ::std::convert::From<PermitTypehashCall> for IERC20Calls {
        fn from(var: PermitTypehashCall) -> Self {
            IERC20Calls::PermitTypehash(var)
        }
    }
    ...
    impl ::std::convert::From<DecreaseAllowanceCall> for IERC20Calls {
        fn from(var: DecreaseAllowanceCall) -> Self {
            IERC20Calls::DecreaseAllowance(var)
        }
    }
    impl ::std::convert::From<IncreaseAllowanceCall> for IERC20Calls {
        fn from(var: IncreaseAllowanceCall) -> Self {
            IERC20Calls::IncreaseAllowance(var)
        }
    }
    ...
    impl ::std::convert::From<NoncesCall> for IERC20Calls {
        fn from(var: NoncesCall) -> Self {
            IERC20Calls::Nonces(var)
        }
    }
    impl ::std::convert::From<PermitCall> for IERC20Calls {
        fn from(var: PermitCall) -> Self {
            IERC20Calls::Permit(var)
        }
    }
